...
IF @flag = 'i'
	...
	INSERT INTO temp_tran(sessionId,entry_user_id,acct_num,dept_id,branch_id,emp_name,field1,field2,part_tran_type,tran_amt,trn_currency,usd_amt,ex_rate,tran_date)
	SELECT  @sessionId,@user,
			...
			krwAmount = p.value('@KRWAMOUNT', 'varchar(35)') ,
