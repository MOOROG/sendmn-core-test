...
<head runat="server">
  ...
  <script type="text/javascript" language="javascript">
    $(document).ready(function () {
      ...
      CalUpToToday("#dtlDate");
      $('#dtlDate').mask('0000-00-00');
    });
    function goBack() {
      window.history.back();
    }
    ...
    function BalanceSheetDtl() {
      var reportDate = $("#dtlDate").val();
      window.location.href = "GL.aspx?company_id=1&mapcode=21&head=Liabilities&bsDtl=1&dt=" + reportDate;
    }
  </script>
</head>
<body>
    ...
    <div class="page-wrapper">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="panel panel-default recent-activites">
            <div class="panel-heading">
              <h4 class="panel-title">Balance Sheet Detail
              </h4>
              <div class="panel-actions">
                <a href="#" class="panel-action panel-action-toggle" data-panel-toggle></a>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-9 col-md-9">
                  <div class="input-group m-b">
                    ...
                    <asp:TextBox ID="dtlDate" onchange="return DateValidation('dtlDate','t')" MaxLength="10" runat="server" CssClass="form-control form-control-inline input-medium"></asp:TextBox>
                  </div>
                </div>
              </div>
              <div class="form-group">
