            ...
            <div class="row" id="main">
                <div class="form-group col-md-3">
                    ...
                    <asp:DropDownList ID="ddlShowAll" runat="server" OnSelectedIndexChanged="ddlShowAll_SelectedIndexChanged" CssClass="form-control" AutoPostBack="true">
                      ...
                      <asp:ListItem Text="Unpaid" Value="cancel"></asp:ListItem>
                      <asp:ListItem Text="Paid Transaction" Value="paid"></asp:ListItem>
                      <asp:ListItem Text="Bank to Wallet" Value="btow"></asp:ListItem>
                      <asp:ListItem Text="Wallet to Bank" Value="wtob"></asp:ListItem>
                    </asp:DropDownList>
                </div>
              <div class="form-group col-md-3">
                <label>Agent: </label>
                <asp:DropDownList ID="ddlShowAgent" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddlShowAgent_SelectedIndexChanged" AutoPostBack="true">
                  <asp:ListItem Enabled="true" Text="Select Agent" Value="all" Selected="True"></asp:ListItem>
                </asp:DropDownList>
              </div>
