<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SettlementHoSearch.aspx.cs" Inherits="Swift.web.AccountReport.SettlementReport.SettlementHoSearch" %>
    ...
    <script type="text/javascript">
        function CheckRequired() {
            ...
            if (ValidRequiredField(reqField) == true) {
                ...
                var url = "/AccountReport/Reports.aspx?reportName=settlementHoReport&branch=" + branch + "&agentId=" + agentId + "&fromDate=" + fromDate + "&toDate=" + toDate;
...
<body>
    <form id="form1" runat="server">
                ...
                <div class="col-sm-12">
                    <div class="page-title">
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="SettlementhoSearch.aspx">Settlement Report</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div class="panel panel-default recent-activites">
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">Settlement Report
                            </h4>
        ...
        <asp:Button ID="populateDDL" runat="server" OnClick="populateDDL_Click" Style="display: none;" />
        <%--</ContentTemplate>
        </asp:UpdatePanel>--%>
    </form>
</body>
