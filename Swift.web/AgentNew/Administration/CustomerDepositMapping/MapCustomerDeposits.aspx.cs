...
namespace Swift.web.AgentNew.Administration.CustomerDepositMapping
{
    public partial class MapCustomerDeposits : System.Web.UI.Page
    {
        ...
        {
            DataTable dt = _dao.GetDataForMapping(GetStatic.GetUser(), isSkipped.SelectedValue);
        ...
        private string GetLinkText(string rowId, string bankname)
        {
            if (isSkipped.SelectedValue == "0")
            {
                ...
                + "&nbsp;<a title=\"Edit\" href=\"javascript:void(0);\">"
                            ...
                            + "</span>"
                        + "</a> "
                + "&nbsp;<a title=\"Edit\" href=\"javascript:void(0);\" " + disp1 + ">"
                            + "<span class=\"action-icon\">"
                                + "<btn class=\"btn btn-xs btn-primary\" onclick=\"return ValidateData('" + rowId + "', 'send','1')\" data-toggle=\"tooltip\" data-placement=\"top\" title=\"Send\">"
        ...
        public void SetMessage(DbResult dbres)
        {
