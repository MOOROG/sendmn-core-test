...
namespace Swift.web.SwiftSystem.UserManagement.PartnerWalletRequest {
  public partial class WithdrawMoneyList : Page {
    protected const string GridName = "grdWithdrawRequest";
    ...
    private void LoadGrid() {
      ...
      _grid.CustomLinkVariables = "id,walletAccountNo";
      _grid.AddPage = "WalletRequest.aspx";
      _grid.ThisPage = "WithdrawMoneyList.aspx";
      _grid.SetComma();
      _grid.InputLabelOnLeftSide = true;
      _grid.SortOrder = "DESC";
      const string sql = "exec [Proc_Partner_Wallet_Request] @flag = 'wmList'";
    ...
    private void State_Click() {
      ...
      DbResult _dbRes = _dao.PartnerWalletRequestState(id,"withdrawRequest",status, GetStatic.GetUser(), "admin", "", GetAgentSession());
