<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="Swift.web.AgentNew.Administration.WithdrawMoneyWallet.Manage" %>
        ...
        <div class="col-sm-12">
          <div class="page-title">
            <ol class="breadcrumb">
              ...
              <li class="active"><a href="List.aspx">Withdraw Money </a></li>
            </ol>
          </div>
          <div class="panel panel-default ">
            <div class="panel-heading">
              <h4 class="panel-title">Withdraw Money In Wallet</h4>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      <div class="col-md-4 col-md-offset-3">
                        <asp:Button ID="btnSearch" runat="server" Text="Get Wallet Details To Withdraw Money" CssClass="btn btn-primary m-t-25"
                    ...
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <div class="col-md-3">
                          ...
                          <br />
                          <asp:Button ID="btnLoadMoney" runat="server" CssClass="btn btn-primary" Text="Withdraw Money" OnClick="btnLoadMoney_Click" />
                          &nbsp;<asp:Button ID="clearData" runat="server" CssClass="btn btn-primary" Text="Clear Data" OnClick="clearData_Click" />

                          <cc1:ConfirmButtonExtender ID="ConfirmButtonExtender1" runat="server"
                            ConfirmText="Are you sure to withdraw money from this wallet number?" Enabled="True" TargetControlID="btnLoadMoney">
