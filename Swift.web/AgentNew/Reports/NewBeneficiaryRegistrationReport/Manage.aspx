<%@ Page Title="" Language="C#" MasterPageFile="~/AgentNew/AgentMain.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="Swift.web.AgentNew.Reports.NewBeneficiaryRegistrationReport.Manage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function showReport() {
            ...
            var url = "../../../RemittanceSystem/RemittanceReports/Reports.aspx?reportName=beneficiaryregistration" +
                "&from=" + fromDate +
                "&to=" + toDate +
                "&sAgent=" + agent +
                "&sBranch=" + branch;
            ...
            <div class="col-sm-12">
                <div class="page-title">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><a href="Manage.aspx">New Beneficiary Registration Report</a></li>
                    </ol>
                </div>
            </div>
        </div>
        <div id="DivFrm" class="col-md-7" runat="server">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <label>New Beneficiary Registration Report</label>
                </div>
