...
namespace Swift.web.AgentNew.SMSLog
{
    public partial class SMSLog : Page
    {
        ...
        private const string GridName = "SMSLogGrid";
        private const string ViewFunctionId = "20308000";
        private const string ReSendFunctionId = "20318010";
        private const string SyncFunctionId = "20308000";
        ...
        private void LoadGrid()
        {
            ...
            {
                new GridFilter("CONTROL_NO", "JME No", "T"),
                new GridFilter("MOBILE_NUMBER", "Mobile No", "T")
            };

            _grid.ColumnList = new List<GridColumn>
                                  {
                                      new GridColumn("CONTROL_NO", "JME No", "", "T"),
