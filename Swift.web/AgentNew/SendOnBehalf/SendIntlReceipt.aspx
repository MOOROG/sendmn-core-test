<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SendIntlReceipt.aspx.cs" Inherits="Swift.web.AgentNew.SendOnBehalf.SendIntlReceipt" %>
...
<body>
    <form id="form1" runat="server">
            ...
            <tr valign="top">
                ...
                <td width="20%" class="amount-info">
                    <table width="100%;" border="1" cellspacing="0 " cellpadding="0 ">
                        <tr>
                            <td>
                                <h2><%=Swift.web.Library.GetStatic.ReadWebConfig("jmeName","") %> NO:<span><asp:Label ID="controlNo" runat="server"></asp:Label></span></h2>
                            </td>
                        </tr>
                        <tr>
                            <td>
        ...
        <table width="100%;" style="margin: 15px 0;" id="divInvoiceSecond" runat="server">
            <tr>
                <td>
            ...
            <tr valign="top">
                ...
                <td width="20%" class="amount-info">
                    <table width="100%;" border="1" cellspacing="0 " cellpadding="0 ">
                        <tr>
                            <td>
                                <h2><%=Swift.web.Library.GetStatic.ReadWebConfig("jmeName","") %> NO:<span><asp:Label ID="controlNo1" runat="server"></asp:Label></span></h2>
                            </td>
                        </tr>
                        <tr>
                            <td>
