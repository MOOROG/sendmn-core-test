<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Calculator.aspx.cs" Inherits="Swift.web.AgentNew.SendTxn.Calculator" %>
                                    ...
                                    <div>
                                        <div class="rowConatainer">
                                            <table class="table table-responsive">
                                                <tr>
                                                    <td>Payout Country:  <span class="errormsg" id='pCountry_err'>*</span></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>Pay Mode: <span class="ErrMsg" id='pMode_err'>*</span></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>Collection Amount:<span class="ErrMsg" id='cAmt_err'>*</span></td>
                                                    <td>
                                                        <asp:TextBox ID="txtCollAmt" runat="server" Enabled="false" CssClass="form-control"></asp:TextBox>
                                                ...
                                                <tr>
                                                    <td>Payout Amount: <span class="ErrMsg" id='Span1'>*</span></td>
                                                    <td>
