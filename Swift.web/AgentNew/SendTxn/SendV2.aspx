...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            console.log(href);
            if (href.indexOf('Admin/Dashboard') > -1 || href.indexOf('admin/Dashboard') > -1) {
                $('.sendm').hide();
            } 
        });
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                ...
                                <table class="table table-responsive">
                                    <tr>
                                        <td>
                                          ...
                                          <p>Receiver Limit:  <span id="receiverLimit" style="color: red; font-weight: bold;"></span></p>
                                        </td>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table">
                                                <tr>
                                                    ...
                                                    <td colspan="3">
                                                        <asp:DropDownList ID="ddlReceiver" runat="server" onchange="DDLReceiverOnChangeBefore();" CssClass="form-control"></asp:DropDownList>
                                                    </td>
                                                </tr>
                                                <tr>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="table-responsive">
                                            <table class="table">
                                                <tr style="">
                                                    <td style="vertical-align: top; width: 27%;">Receiving Country:
                                                ...
                                                <td>
                                                  <asp:RadioButtonList ID="whichCurr" runat="server" RepeatDirection="Horizontal">
                                                    <asp:ListItem Text="USD" Value="USD" Selected="True" />
                                                    <asp:ListItem Text="KRW" Value="KRW" />
                                                  </asp:RadioButtonList>
                                                </td>
                                              </tr>
                                    ...
                                    <div class="col-md-6">
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <td>
                                                  <asp:TextBox ID="trDescriptionTxtBox" runat="server" CssClass="form-control" ></asp:TextBox>
                                                </td>
                                              </tr>
                                                <tr>
  ...
  <asp:HiddenField ID="forexSessionId" runat="server" />
  <asp:HiddenField ID="hddSenderIsOrg" runat="server" />
  <asp:HiddenField ID="hddReceiverIsOrg" runat="server" />
  <asp:HiddenField ID="hddReceiverBinn" runat="server" />
  <asp:HiddenField ID="hddReceiverBikk" runat="server" />
    ...
    <script src="/AgentNew/js/SendTxn/sendTxnInfo.js?v2.7" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        function DDLReceiverOnChangeBefore() {
            DDLReceiverOnChange();
        }
    </script>
</asp:Content>