...
namespace Swift.web.AgentNew.SendTxn
{
    public partial class SendV2 : System.Web.UI.Page
    {
        ...
        private void PopulateDdl()
        {
            ...
            _sdd.SetDDL(ref sendingAgentOnBehalfDDL, "EXEC proc_sendPageLoadData @flag='S-AGENT-BEHALF',@user='" + GetStatic.GetUser() + "'", "agentId", "agentName", "", "Select Branch/Agent");
        ...
        private void PopulateData()
        {
            ...
            DataTable dt = _dao.GetDataForSendMapping(GetStatic.GetUser(), trnDate, particulars);
            StringBuilder sb = new StringBuilder();
            ...
            {
                sb.AppendLine("<tr>");
                sb.AppendLine("<td><input type='checkbox' name='chkDepositMapping' value='" + item["tranId"].ToString() + "' checked='true'/></td>");
