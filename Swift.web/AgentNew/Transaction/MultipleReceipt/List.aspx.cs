...
namespace Swift.web.AgentNew.Transaction.MultipleReceipt
{
    public partial class List : System.Web.UI.Page
    {
        ...
        private void LoadGrid()
        {
            ...
            {
                sql = "[proc_remitTransaction] @flag='s',@customerId='" + customerId + "',@fromDate='" + fromDate.Text + "',@toDate='" + toDate.Text + "',@controlNumber='" + controlNumber.Text + "'";
            }
            else
            {
                sql = "[proc_remitTransaction] @flag='s',@customerId='" + customerId + "',@fromDate='" + fromDate.Text + "',@toDate='" + toDate.Text + "'";
            }
            _grid.SetComma();
        ...
        protected void btnPrintReceipt_Click(object sender, EventArgs e)
        {
            ...
            var printType = copyType.SelectedValue;

            //string[] trnids = a.Split(',');
            GetStatic.WriteSession("tranIds", trnids);
            GetStatic.WriteSession("copyType", printType);
