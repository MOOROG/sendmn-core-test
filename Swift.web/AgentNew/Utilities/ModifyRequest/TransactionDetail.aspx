<%@ Page Title="" Language="C#" MasterPageFile="~/AgentNew/AgentMain.Master" AutoEventWireup="true" CodeBehind="TransactionDetail.aspx.cs" Inherits="Swift.web.AgentNew.Utilities.ModifyRequest.TransactionDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        function Delete(obj) {
            document.getElementById("<%=rowid.ClientID%>").value = obj;
                                ...
                                <table id="Table1" runat="server" class="table">
                                    <tr>
                                        ...
                                        SetFocusOnError="True">
                                                                    ...
                                                                    <td style="vertical-align: top; display: none;" nowrap="nowrap">
