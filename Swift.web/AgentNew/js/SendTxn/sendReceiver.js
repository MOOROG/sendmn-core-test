...
function ParseResponseForReceiverData(response) {
    ...
    if (data.length > 0) {
      ...
      $("#receiverLimit").text(data[0].receiveLimit);
      ...
      if (data[0].receiverType == '4701') {
        $("#" + mId + "hddReceiverIsOrg").val('1');
      } else {
        $("#" + mId + "hddReceiverIsOrg").val('0');
      }
      $("#" + mId + "hddReceiverBinn").val(data[0].bInn);
      $("#" + mId + "hddReceiverBikk").val(data[0].bIkk);
