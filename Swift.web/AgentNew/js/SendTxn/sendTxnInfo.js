...
function CalculateTxn(amt, obj, isManualSc) {
  ...
  var receiverIsOrg = $("#" + mId + "hddReceiverIsOrg").val();
    var dataToSend = {
    ...
    var options =
    {
        ...
        async: false,
        success: function (response) {
            ParseCalculateDataMine(response, obj);
        }
    };
    $.ajax(options);
    $("#DivLoad").hide();
...
function SendTransactionMethod() {
    ...
    pBankText = "";
  var pBankVal = $("#" + mId + "pAgent option:selected").val();
  ...
  sessionStorage.setItem("XmlDataForQuestinnarie", Questionnarie);
    ...
    //    alert('Please choose collect mode first!123');
    //    return false;
  ...
  var fxSessionId = $("#" + mId + "forexSessionId").val();

  var senderIsOrg = $("#" + mId + "hddSenderIsOrg").val();
  var receiverIsOrg = $("#" + mId + "hddReceiverIsOrg").val();
  var receiverBinn = $("#" + mId + "hddReceiverBinn").val();
  var receiverBikk = $("#" + mId + "hddReceiverBikk").val();
  var transactionDescription = GetValue(mId + "trDescriptionTxtBox");
  var whichCur = $("#" + mId + "whichCurr input:checked").val();
    var url = "Confirm.aspx?senderId=" + senderId +
      ...
      "&pBankText=" + FilterString(pBankVal) +
      ...
      "&receiverIsOrg=" + receiverIsOrg +
      "&receiverBinn=" + receiverBinn +
      "&receiverBikk=" + receiverBikk + 
