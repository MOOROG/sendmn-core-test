<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Send.aspx.cs" Inherits="Swift.web.AgentPanel.International.SendMoney.Send" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        //    $.ajax({
        //        url: "Send.aspx",
        //        data: { rCountry: rcountry },
        //        success: function (response) {
        //            if (response.message == null || response.message == "") {
        //                return fals;
        //            }
        //            else {
        //                $("#amlMessage").html(response.message);
        //            }
        //        }
        //    });
        //});
        ...
        $(function () {
            $('#ddSenIdType').change(function () {
                var idType = $("#ddSenIdType option:selected").text();

                if (idType == "Alien Registration Card") {
                    $(".showHideIDExpDate").css("display", "block");
                }
                else {
                    $(".showHideIDExpDate").css("display", "none");
                }
            });
    ...
    <script type="text/javascript" language="javascript">
        ...
        //$(function () {
        //    var agentId = GetpAgentId();
        //    if(agentId == "" || agentId == null)
        //    {
        //        alert("Please Choose Valid Agent Name ");
        //        return false;
        //    }
        ...
        function ReceivingModeOnChange(pModeSelected, pAgentSelected) {
            ...
            $("#tdLblLocation").hide();
            $("#tdTxtLocation").hide();
            $('#txtpLocation_Text').attr("class", "disabled form-control");
        ...
        $("#pCountry").change(function () {
            ...
            if ($("#pMode option:selected").val() == "2")
            {
                $(".same").css("display","");
            }
            else
       ...
       <%-- $("#pAgent").change(function () {
            ...
            if ($("#pAgent option:selected").val() != "") {
                ...
                if (pmode == "DOOR TO DOOR") {
                    $("#tdLblLocation").show();
                    $("#tdTxtLocation").show();
                    $('#txtpLocation_Text').attr("class", "required disabled form-control");
                }
                PAgentChange();
                SchemeByPCountry();
                ...
                $("#tdLblLocation").hide();
                $("#tdTxtLocation").hide();
                $('#txtpLocation_Text').attr("class", "form-control");
            }
    ...
    function ParseCalculateData(response, amtType) {
        ...
        $('#lblServiceChargeAmt').text(parseFloat(data[0].scCharge).toFixed(0));
    ...
    function SchemeByPCountry() {
        ...
        SetValueById("<%=txtSendMobile.ClientID %>", "+82", "");
    ...
    $(function () {
        $('#calc').click(function () {
            ...
            var sCity = GetItem("txtSendCity")[0];
...
<body>
    <form id="form2" runat="server">
        ...
        <div class="page-wrapper">
            ...
            <div id="divLoad" style="position: fixed; left: 450px; top: 0px; background-color: white; border: 1px solid black; display: none;">
                    ...
                    <div class="col-md-12">
                            ...
                            <div class="panel-body" id="divHideShow">
                                <table class="table table-responsive">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtSearchData" runat="server" Text="" CssClass="form-control"></asp:TextBox>
                                        </td>
                                        <td>
                                            <input name="button2" type="button" id="btnSearchCustomer" value="Search" class="btn btn-primary" />
                        ...
                        <div class="panel panel-default margin-b-30">
                            ...
                            <div class="panel-body">
                                <table class="table table-responsive">
                                    <tr>
                                        ...
                                        <td>Receiving Mode:<span class="ErrMsg">*</span>
                                        </td>
                                        <td>
                            ...
                            <span class="ErrMsg">*</span>                        </td>
                                    ...
                                    <tr id="trAccno" style="display: none;">
                                        <td>Bank Account No:
                            <span id="txtRecDepAcNo_err" class="ErrMsg">*</span>                        </td>
                                        <td colspan="3">
                           ...
                           <span class="ErrMsg" id='txtCollAmt_err'>*</span>                        </td>
                                        <td>
                            ...
                            <span id="tdLblLocation_err" class="ErrMsg">*</span>
                                        </td>

                                        <td id="tdTxtLocation" style="display: none;">
                                            <input type="text" id="txtpLocation_Text" style="width: 130px" readonly="readonly" class="disabled form-control" />
                                            <input type="hidden" id="txtpLocation_Value" />
                                            <input type="button" id="BtnLocation" onclick="PickLocation();" value="Search Location" class="btn btn-primary" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Service Charge: </td>
                                        <td>
                                            <asp:Label ID="lblServiceChargeAmt" runat="server" Text="0" class="amountLabel"></asp:Label>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <table class="table table-responsive">
                                    <tr>
                                        <td style="width: 135px;">Full Name:
                                        <span class="ErrMsg" id='txtSendFirstName_err'>*</span>
                                        </td>
                                        <td colspan="3">
                                            <asp:TextBox ID="txtSendFirstName" placeholder="Enter Name as in Passbook" runat="server" CssClass="required SmallTextBox form-control" onblur="CheckForSpecialCharacter(this,'Sender First Name');"></asp:TextBox>
                                        </td>

                                        <asp:TextBox Style="display: none" ID="txtSendMidName" runat="server" CssClass="SmallTextBox form-control" onblur="CheckForSpecialCharacter(this, 'Sender Middle Name');"></asp:TextBox>
                                    </tr>
                                    <tr style="display: none">
                                        <td>Last Name:</td>
                                        <td>
                                            <asp:TextBox ID="txtSendLastName" runat="server" CssClass="SmallTextBox form-control" onblur="CheckForSpecialCharacter(this, 'Sender Last Name');"></asp:TextBox>
                                    ...
                                    <tr id="trSenId" runat="server">
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtSendIdNo" placeholder="E.g xxxxxx-xxxxxxx" MaxLength="14" runat="server" CssClass="form-control" onblur="CheckSenderIdNumber(this);"></asp:TextBox>
                                            <br />
                                    ...
                                    <tr id="trIdExpirenDob" runat="server">
                                        ...
                                        <td id="tdSenExpDateTxt" runat="server" nowrap="nowrap" class="showHideIDExpDate">
                                    ...
                                    <tr id="trSenContactNo" runat="server">
                                        ...
                                        <td id="tdSenMobileNoTxt" runat="server">
                                            <asp:TextBox ID="txtSendMobile" runat="server" Text="+82" CssClass="form-control" MaxLength="13"></asp:TextBox>
                                        </td>
                                        ...
                                        <td id="tdSenTelNoTxt" runat="server">
                                            <asp:TextBox ID="txtSendTel" runat="server" CssClass="form-control" onblur="CheckForMobileNumber(this);" MaxLength="17"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td id="tdSenCityTxt" runat="server">
                                            ...
                                            <%--<asp:TextBox ID="txtSendCity" runat="server" CssClass="form-control" onblur="CheckForSpecialCharacter(this, 'Sender City');"></asp:TextBox>--%>
                                        </td>

                                        <asp:TextBox ID="txtSendPostal" Style="display: none" runat="server" CssClass="form-control" onblur="CheckForSpecialCharacter(this, 'Sender Postal Code');"></asp:TextBox>
                                    </tr>
                                    <tr id="trSenCompany" runat="server">
                                        ...
                                        <td colspan="3">
                                            <asp:TextBox ID="companyName" runat="server" CssClass="form-control" onblur="CheckForSpecialCharacter(this, 'Sender Company Name');"></asp:TextBox>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>Email:</td>
                                        <td colspan="3">
                                            <asp:TextBox ID="txtSendEmail" runat="server" CssClass="LargeTextBox form-control"></asp:TextBox>
                            ...
                            <div class="panel-heading">
                                <table class="table table-responsive">
                                    <tr>
                                        ...
                                        <td style="float: right; margin-right: 15px;">
                                            <%--<a href="javascript:void(0);" class="button" onclick="PickReceiverFromSender('r');">Select Receiver</a>--%>
                            ...
                            <div class="panel-body">
                                <table class="table table-responsive">
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <asp:TextBox ID="txtRecFName" runat="server" placeholder="First Name         Last Name " CssClass="required SmallTextBox form-control" onblur="CheckForSpecialCharacter(this, 'Receiver First Name');"></asp:TextBox>
                                        </td>

                                        <asp:TextBox ID="txtRecMName" runat="server" Style="display: none" CssClass="SmallTextBox form-control" onblur="CheckForSpecialCharacter(this, 'Receiver Middle Name');"></asp:TextBox>
                                    </tr>
                                    <tr style="display: none">
                                        <td>Last Name:</td>
                                        <td>
                                            <asp:TextBox ID="txtRecLName" runat="server" CssClass="SmallTextBox form-control" onblur="CheckForSpecialCharacter(this, 'Receiver Last Name');"></asp:TextBox>
                                    ...
                                    <tr id="trRecId" runat="server">
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtRecIdNo" runat="server" MaxLength="7" CssClass="form-control" onblur="CheckForSpecialCharacter(this, 'Receiver ID Number');"></asp:TextBox>
                                        </td>
                                    </tr>
                                    ...
                                    <tr id="trRecContactNo" runat="server">
                                        <td id="tdRecMobileNoLbl" runat="server">
                                            ...
                                            <span runat="server" class="ErrMsg" id='txtRecMobile_err'>*</span>
                                        </td>
                                        <td id="tdRecMobileNoTxt" runat="server">
                                            <asp:TextBox ID="txtRecMobile" runat="server" CssClass="form-control" onblur="CheckForMobileNumber(this, 'Receiver Mobile No.');"></asp:TextBox>
                                        </td>
                                        ...
                                        <td id="tdRecTelNoTxt" runat="server">
                                            <asp:TextBox ID="txtRecTel" runat="server" CssClass="form-control" onblur="CheckForMobileNumber(this, 'Receiver Tel. No.');"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td id="tdRecCityTxt" runat="server">
                                            <asp:TextBox ID="txtRecCity" runat="server" CssClass="form-control" onblur="CheckForSpecialCharacter(this, 'Receiver City');"></asp:TextBox>
                                        </td>
                                    ...
                                    <tr>
                                        <td>Email:</td>
                                        <td colspan="3">
                                            <asp:TextBox ID="txtRecEmail" runat="server" CssClass="LargeTextBox form-control"></asp:TextBox>
    ...
    $('#txtSendDOB').blur(function () {
        ...
        $(function () {
            $("#<%= pAgent.ClientID %>").change(function () {
                ...
                $.get("/AgentPanel/International/SendMoney/FormLoader.aspx", { bankId: bankId, type: 'bb' }, function (data) {
                    var res = data;
