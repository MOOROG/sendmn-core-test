<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SendV2.aspx.cs" Inherits="Swift.web.AgentPanel.International.SendMoney.SendV2" %>
...
//    }
    ...
    function LoadCustomerRate() {
        ...
        var dataToSend = { MethodName: 'LoadCustomerRate', pCountry: pCountry, pMode: pMode, pAgent: pAgent, collCurr: collCurr
        };
    ...
    function CalculateTxn(amt, obj) {
        ...
        var dataToSend = { MethodName: 'CalculateTxn', pCountry: pCountry, pCountrytxt: pCountrytxt, pMode: pMode, pAgent: pAgent
...
<body>
    <div class="breadCrumb">Send Money » Send Transaction</div>
    <form id="form2" runat="server" style="margin: 150px 150px;">
        ...
        <div id="divStep1" class="mainContainer">
            ...
            <div class="rowContainer">
                ...
                <table width="840px" cellspacing="0" cellpadding="0" class="formTable">
                    <tr>
                        ...
                        <td width="232" class="frmTitle" style="display: none">
                    ...
                    <tr>
                        <td colspan="3">
                            <table width="840px" cellspacing="0" cellpadding="0" id="tblSearch">
                                <tr>
                                    <td width="148" style="width: 135px;">
                                        <asp:DropDownList ID="ddlCustomerType" runat="server" Style="width: 220px; height: 30px;">
                                            ...
                                            <asp:ListItem Value="controlNo" Text="ICN (IME Control No.)"></asp:ListItem>
                                        </asp:DropDownList></td>
                                    <td>
                                        <asp:TextBox ID="txtSearchData" runat="server" CssClass="SmallTextBox" Text=""></asp:TextBox>
                                        ...
                                        <span style="display: none;">Country: </span><span style="width: 135px; display: none;">
                                            <asp:DropDownList ID="sCountry" runat="server" Style="width: 220px; height: 30px;"></asp:DropDownList>
                                        </span></td>
                                </tr>
                                <tr>
                                    <td colspan="2">
            ...
            <div class="rowContainer">
                <table width="840px" cellspacing="0" cellpadding="0" class="formTable">
                    <tr>
                        <td class="frmTitle" colspan="4" nowrap="nowrap">Transaction Information:
                    ...
                    <tr>
                        <td style="width: 135px;" nowrap="nowrap">Receiving Country:
                            <span class="ErrMsg" id='pCountry_err'>*</span>
                        </td>
                        <td nowrap="nowrap">
                            <asp:DropDownList ID="pCountry" runat="server" Style="width: 220px; height: 30px;" CssClass="required"></asp:DropDownList>
                        </td>
                        <td nowrap="nowrap">Receiving Mode:
                            <span class="ErrMsg" id='pMode_err'>*</span>
                        </td>
                        <td nowrap="nowrap">
                            <asp:DropDownList ID="pMode" runat="server" Style="width: 220px; height: 30px;" CssClass="required"></asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <td nowrap="nowrap">
                            <span id="lblPayoutAgent">Agent / Bank:</span>
                            <span class="ErrMsg" id="pAgent_err">*</span>                        </td>
                        <td nowrap="nowrap">
                            <asp:DropDownList ID="pAgent" runat="server" Style="width: 220px; height: 30px;"></asp:DropDownList>
                            <asp:DropDownList ID="pAgentDetail" runat="server" Style="width: 220px; height: 30px; display: none;"></asp:DropDownList>
                            <asp:DropDownList ID="pAgentMaxPayoutLimit" runat="server" Style="width: 220px; height: 30px; display: none;"></asp:DropDownList>
                            <span id="hdnreqAgent" style="display: none"></span>
                            <input type="hidden" id="hdnBankType" />
                        </td>
                        <td id="tdLblBranch" style="display: none;">Branch:
                            <span id="txtpBranch_err" class="ErrMsg">*</span>                        </td>
                        <td id="tdTxtBranch" style="display: none;">
                            <input type="text" id="txtpBranch_aText" style="width: 150px" />
                            <input type="hidden" id="txtpBranch_aValue" />

                            <span id="hdnreqBranch" style="display: none"></span>
                            <span class="ErrMsg" id="reqBranch" style="display: none"></span>
                            <input id="btnPickBranch" type="button" value="Search" onclick="PickpBranch();" />
                    ...
                    <tr id="trForCPOB" style="display: none;">
                        ...
                        <td colspan="3">
                            <asp:DropDownList ID="paymentThrough" runat="server" Style="width: 220px; height: 30px;"></asp:DropDownList>
                        </td>
                    </tr>
                    <tr id="trAccno" style="display: none;">
                        ...
                        <td colspan="3">
                            <asp:TextBox ID="txtRecDepAcNo" runat="server" CssClass="SmallTextBox" Width="200px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr id="trScheme" style="display: none;">
                        <td>Scheme/Offer:</td>
                        <td>
                            <asp:DropDownList ID="ddlScheme" runat="server" Style="width: 220px; height: 30px;"></asp:DropDownList>
                        </td>
                        <td id="tdItelCouponIdLbl" style="display: none;">ITEL Coupon ID:</td>
                        <td id="tdItelCouponIdTxt" style="display: none;">
                            <asp:TextBox ID="iTelCouponId" runat="server" Width="120px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtPayAmt" runat="server" Enabled="false" CssClass="required BigAmountField disabled"></asp:TextBox>
                ...
                <table width="840px" cellspacing="0" cellpadding="0" class="formTable">
                    <tr>
                        <td class="frmTitle" colspan="4">
                            <div style="float: left;">Sender Information: <span id="senderName"></span></div>
                            <div style="float: right;"><a href="javascript:void(0);" class="button" onclick="PickReceiverFromSender('s');">View Transaction History</a></div>
                            <input id="btnBen" type="button" onclick="ShowHide(this, 'tblSend');" value="-" title="Show/Hide" class="tg-button" />
                        </td>
                    </tr>
                    <tr>
                        <td>
            ...
            <div class="rowContainer">
                <table width="840px" cellspacing="0" cellpadding="0" class="formTable">
                    <tr>
                        <td class="frmTitle" colspan="4">
                            <div style="float: left;">Receiver Information:  <span id="receiverName"></span></div>
                            <div style="float: right;">
                                <a href="javascript:void(0);" class="button" onclick="PickReceiverFromSender('r');">Select Receiver</a>
                                <input id="btnReceiverClr" type="button" value="Clear" />
                            </div>
                            <input id="Button1" type="button" onclick="ShowHide(this, 'tblBen');" value="-" title="Show/Hide" class="tg-button" />
                        </td>
                    </tr>
                    <tr>
                        <td>fg
                            <table id="tblBen" cellspacing="0">
                                ...
                                <tr id="trRecId" runat="server">
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlRecIdType" runat="server" Style="width: 134px; height: 30px;"></asp:DropDownList>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlRecGender" runat="server" Style="width: 136px; height: 30px;">
                                            <asp:ListItem Value="">Select</asp:ListItem>
                                            <asp:ListItem Value="Male">Male</asp:ListItem>
                                            <asp:ListItem Value="Female">Female</asp:ListItem>
                                        </asp:DropDownList>
            ...
            <div class="rowContainer">
                <table width="840px" cellspacing="0" cellpadding="0" class="formTable">
                    <tr>
                        <td class="frmTitle" colspan="2">
                            <div style="float: left;">Customer Due Diligence Information -(CDDI) </div>
                            <input id="Button2" type="button" onclick="ShowHide(this, 'tblAdditional');" value="-" title="Show/Hide" class="tg-button" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <table id="tblAdditional" cellspacing="0">
                                <tr id="trOccupation" runat="server">
                                    <td width="172" style="width: 170px">
                                        ...
                                        <span runat="server" class="ErrMsg" id='occupation_err'>*</span>                                    </td>
                                    <td width="357">
                                        <asp:DropDownList ID="occupation" runat="server" Style="width: 220px; height: 30px;"></asp:DropDownList>
                                    </td>
                                </tr>
                                <tr id="trSourceOfFund" runat="server">
                                    <td>
                                        <asp:Label runat="server" ID="lblSof" Text="Source of Fund:"></asp:Label>
                                        <span runat="server" class="ErrMsg" id='sourceOfFund_err'>*</span>                                    </td>
                                    <td>
                                        <asp:DropDownList ID="sourceOfFund" runat="server" Style="width: 220px; height: 30px;"></asp:DropDownList>
                                    </td>
                                </tr>
                                <tr id="trPurposeOfRemittance" runat="server">
                                    <td>
                                        <asp:Label runat="server" ID="lblPoRemit" Text="Purpose of Remittance:"></asp:Label>
                                        <span runat="server" class="ErrMsg" id='purpose_err'>*</span>                                    </td>
                                    <td>
                                        <asp:DropDownList ID="purpose" runat="server" Style="width: 220px; height: 30px;"></asp:DropDownList>
                                    </td>
                                </tr>
                                <tr id="trRelWithRec" runat="server">
                                    <td>
                                        <asp:Label runat="server" ID="lblRelation" Text="Relationship with Receiver:"></asp:Label>
                                        <span runat="server" class="ErrMsg" id='relationship_err'>*</span>                                    </td>
                                    <td>
                                        <asp:DropDownList ID="relationship" runat="server" Style="width: 220px; height: 30px;"></asp:DropDownList>
                                    </td>
                                </tr>
                                <tr id="trSalaryRange" runat="server">
                                    <td>
                                        <asp:Label runat="server" ID="lblSalaryRange" Text="Monthly Income:"></asp:Label>
                                        <span runat="server" id="ddlSalary_err" class="ErrMsg">*</span>								 </td>
                                    <td>
                                        <asp:DropDownList ID="ddlSalary" runat="server" Style="width: 220px; height: 30px;"></asp:DropDownList></td>
                                </tr>
                                <tr>
