<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageCustomer.aspx.cs" Inherits="Swift.web.AgentPanel.OnlineAgent.CustomerControls.ManageCustomer" %>
            ...
            <div class="report-tab" runat="server" id="regUp">
                ...
                <div class="listtabs">
                    <ul class="nav nav-tabs" role="tablist">
                        <li><a href="ManageList.aspx" aria-controls="home" role="tab" data-toggle="tab">Customer List</a></li>
