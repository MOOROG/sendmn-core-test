<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="Swift.web.AgentPanel.OnlineAgent.CustomerSetup.Manage" %>
...
<head id="Head1" runat="server">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            AllowFutureDate("#ExpireDate");
            CalSenderDOB("#dob");
            CalTillToday("#IssueDate");
            ...
            $("#<%=chkConfirm.ClientID%>").change(function () {
                $("#<%=register.ClientID%>").hide();
                if (this.checked) {
                    $("#<%=register.ClientID%>").show();
                }
            });
        });
        ...
        function dateChange() {
            var expiryDate = toDate($('#ExpireDate').val());
            var today = new Date();
            ...
            if (expiryDate < today) {
                $('#ExpireDate').val('');
                $('#ExpireDate').focus();
                alert('Expiry date can not be smaller then todays date!');
                return false;
            }
            return true;
        }
        ...
        function CheckFormValidation() {
            ...
            if (val !== "") {
                reqField = "ddlBankName,accountNumber,email,emailConfirm,firstName,countryList,city,nativeCountry,mobile,occupation,idType,verificationTypeNo,ExpireDate,";
            } else {
                reqField = "ddlBankName,accountNumber,email,emailConfirm,firstName,countryList,city,nativeCountry,mobile,occupation,idType,verificationTypeNo,VerificationDoc2,VerificationDoc3,ExpireDate,";
            }
            if ($('#idType').val() == '8008') {
        ...
        function ManageDivs() {
            var idName = $('#idType option:selected').text();
            if (idName == "Passport") {
            }
            ...
            <div class="report-tab" runat="server" id="regUp">
                ...
                <div class="listtabs">
                    <ul class="nav nav-tabs" role="tablist">
                        <li><a href="List.aspx">Unapproved List</a></li>
                        <li><a href="ListApproved.aspx">Approved List</a></li>
                        <li role="presentation" class="active"><a href="javascript:void(0);" aria-controls="home" role="tab" data-toggle="tab">Customer Operation</a></li>
                    </ul>
                </div>
                                ...
                                <div class="register-form">
                                        ...
                                        <div class="panel-body row">
                                            ...
                                            <div class="col-sm-4" style="display: none">
                                                <div class="form-group">
                                                    ...
                                                    <asp:TextBox ID="middleName" runat="server" placeholder="Middle Name" CssClass="form-control" />
                                                </div>
                                            </div>
                                            <div class="col-sm-4" style="display: none">
                                                <div class="form-group">
                                                    <label>Last Name:<span class="errormsg">*</span></label>
                                                    <asp:TextBox ID="lastName" runat="server" placeholder="Last Name" CssClass="form-control" />
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                    ...
                                    <div class="panel panel-default clearfix m-b-20">
                                        ...
                                        <div class="panel-body row">
                                            ...
                                            <div class="col-sm-4" id="dibDob">
                                                <div class="form-group">
                                                    <label>Date of Birth: <span class="errormsg">*</span></label>
                                                    <div class="form-inline">
                                                        <div class="input-group input-append date dpYears">
                                                            <asp:TextBox runat="server" ID="dob" CssClass="form-control date-DOB"></asp:TextBox>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-4" id="expiryDiv" runat="server">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group input-append date">
                                                            <asp:TextBox runat="server" ID="ExpireDate" CssClass="form-control" onchange="return dateChange();"></asp:TextBox>
                                                            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <%--<label>Visa Page:</label>--%>
                                                    <label>Customer Selfie:<span class="errormsg">*</span></label>
                                            ...
                                            <div class="col-sm-12" runat="server">
                                                <div class="form-group">
                                                    <asp:Button ID="register" Style="display: none" runat="server" CssClass="btn btn-primary m-t-25" Text="Submit" OnClientClick="return CheckFormValidation()" OnClick="register_Click" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
