<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageApproved.aspx.cs" Inherits="Swift.web.AgentPanel.OnlineAgent.CustomerSetup.ManageApproved" %>
            ...
            <div class="report-tab" runat="server" id="regUp">
                ...
                <div class="listtabs">
                    <ul class="nav nav-tabs" role="tablist">
                        <li><a href="ListApproved.aspx" aria-controls="home" role="tab" data-toggle="tab">Approved List</a></li>
                                        ...
                                        <div class="panel-body row">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    ...
                                                    <asp:DropDownList runat="server" ID="idType" CssClass="form-control"></asp:DropDownList>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
