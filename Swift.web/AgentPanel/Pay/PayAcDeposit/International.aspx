<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="International.aspx.cs" Inherits="Swift.web.AgentPanel.Pay.PayAcDeposit.International" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="bredCrom" style="width: 90%">PAY MONEY » Pay A/C Deposit- International</div>
        <div>
            <table>
                <tr>
                    <td>
