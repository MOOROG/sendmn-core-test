...
{
    public partial class PendingTxnListDom : System.Web.UI.Page
    {
        public const string GridName = "grdPendingTxnDom";
        ...
        private void LoadGrid(bool viewBulkPay)
        {
            ...
            string sql = "exec proc_PayAcDepositAgentV2_Dom @flag = 'pendingList-dom', @pAgent='" + GetStatic.GetAgent() + "'";
            _grid.SetComma();
