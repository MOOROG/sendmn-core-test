<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="drilDown.aspx.cs" Inherits="Swift.web.AgentPanel.Reports.SOADomestic.drilDown" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:Label runat="server" ID="rptDetail" Style="font-size: medium"></asp:Label>
            ...
            Generated On=
                    ...
                    <div id="rptDiv" runat="server" style="margin-top: 10px;"></div>
                </div>
            </div>
        </div>
    </form>
