<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="Swift.web.AgentPanel.Reports.SettlementDomestic.Manage" %>
                        ...
                        <div class="row panels">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group m-b">
                                    ...
                                    <asp:TextBox autocomplete="off" ID="toDate" runat="server" class="dateField form-control" Width="100%"></asp:TextBox>
                                </div>
