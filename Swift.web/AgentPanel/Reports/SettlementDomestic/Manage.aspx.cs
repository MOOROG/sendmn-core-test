...
namespace Swift.web.AgentPanel.Reports.SettlementDomestic
{
    public partial class Manage : System.Web.UI.Page
    {
        ...
        {
            string sql = "EXEC " + GetUtilityDAO.AccountDbName() + ".dbo.PROC_SETTLEMENT_REPORT_V2 @FLAG = 'DDL_BRANCH',@AGENT =" + _rl.FilterString(aMapCode) + "";
