<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="Swift.web.AgentPanel.Reports.TxnDetail.Manage" %>
                                ...
                                <tr>
                                    ...
                                    <td>From Date
                                            <div class="input-group m-b">
                                                ...
                                                <asp:TextBox ID="frmDate" onchange="return DateValidation('frmDate','t','toDate')" MaxLength="10" runat="server" Width="260px" CssClass="form-control"></asp:TextBox>
                                            </div>
                                    </td>
                                    <td>To Date
                                        <div class="input-group m-b">
                                            ...
                                            <asp:TextBox ID="toDate" onchange="return DateValidation('frmDate','t','toDate')" MaxLength="10" runat="server" Width="260px" CssClass="form-control"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr style="display: none;">
                                    <td></td>
