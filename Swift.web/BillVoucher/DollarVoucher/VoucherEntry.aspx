<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VoucherEntry.aspx.cs" Inherits="Swift.web.BillVoucher.DollarVoucher.VoucherEntry" %>
                        ...
                        <div class="panel-body">
                            <table class="table table-responsive change">
                                <tr>
                                    ...
                                    <td>FCY Amount</td>
                                    <td class="hidden">
                                        <span id="lblRate" style="font-size: 10px !important">
                                            Rate 
                                        </span>
                                    </td>
                                    <td class="hidden">KRW Amount</td>
                                    <td>DR/CR</td>
                                    <td>Department</td>
                                    <td>Branch</td>
                                    <td>Employee Name</td>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 120px !important">
                                        <asp:TextBox ID="FCYAmt" placeholder="FCY Amount" runat="server" size="15" CssClass="form-control"></asp:TextBox>
                                    </td >
