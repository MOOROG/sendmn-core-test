...
namespace Swift.web.BillVoucher.ManualVoucher
{
    public partial class List : System.Web.UI.Page
    {
        private const string ViewFunctionId = "20102000,20102010,20102020,20102030";
        private const string DateFunctionId = "20102040";
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            var res = _vrd.SaveTempTransactionManual(GetStatic.GetSessionId(), date, narrationField.Text, voucherType.SelectedValue, chequeNo.Text, vNum.Text);
            if (res.ErrorCode == "0")
            {
                chequeNo.Text = "";
                narrationField.Text = "";
