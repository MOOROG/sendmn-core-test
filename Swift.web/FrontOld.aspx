<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FrontOld.aspx.cs" Inherits="Swift.web.Font" %>
 ...
 <script type="text/javascript">
     function OpenInNewWin(urlType) {
       ...
       url = '../RemittanceSystem/RemittanceReports/Reports.aspx?reportName=20163300&fromDate=<%= GetDate() %>&toDate=<%= GetDate() %>&rCountry=Nepal&ctype=Approved&transType=Cancel&rptType=s&displayTranNo=N';
         ...
         else if (urlType == 'cashCode') {
             url = 'OtherServices/SendMNAPI/ListCashCode.aspx';
         }
         else if (urlType == 'manuals') {
             url = 'OtherServices/Manuals/Manuals.aspx';
         }
         else if (urlType == 'custRanking') {
             url = 'OtherServices/SendMNAPI/CustomerRankingList.aspx';
         }
         OpenInNewWindow(url);
         return false;
     }
 ...
 <form id="form1" runat="server">
  <div class="page-wrapper">
   <div class="row" id="divPopulateTxnCount" runat="server">
    ...
    <div class="col-sm-6 col-md-3 margin-b-30">
     <div class="tile blue" style="background-color: orange">
      <div class="tile-title clearfix">
       Cash Payment Code List
      </div>
      <div class="tile-body clearfix">
       <i class="fa fa-credit-card"></i>
       <h4 class="pull-right">
        <a style="color: white;" onclick=" return OpenInNewWin('cashCode');" href="#">
         <asp:Label runat="server" ID="iCode"></asp:Label>
        </a>
       </h4>
      </div>
      <div class="tile-footer">
       <a onclick="return OpenInNewWin('cashCode');" href="#">View Details...</a>
      </div>
     </div>
    </div>

    <div class="col-sm-6 col-md-3 margin-b-30">
     <div class="tile blue" style="background-color: deepskyblue">
      <div class="tile-title clearfix">
       <%=Swift.web.Library.GetStatic.ReadWebConfig("copyRightName","") %>  Manuals
      </div>
      <div class="tile-body clearfix">
       <i class="fa fa-book"></i>
       <h4 class="pull-right">
        <h4 class="pull-right">
         <a style="color: white;" onclick=" return OpenInNewWin('manuals');" href="#">
          <asp:Label runat="server" ID="Label1">Manuals</asp:Label>
         </a>
        </h4>
      </div>
      <div class="tile-footer">
    ...
    <div class="col-sm-6 col-md-3 margin-b-30">
     <div class="tile blue" style="background-color: orange">
      ...
      <div class="tile-body clearfix">
       <h2>
        <asp:Label runat="server" ID="diff"></asp:Label>
        <asp:Label runat="server" ID="norm"></asp:Label>
        <asp:Label runat="server" ID="easy"></asp:Label>
       </h2>
      </div>
      <div class="tile-footer">
       <a onclick="return OpenInNewWin('custRanking');" href="#">View Details...</a>
      </div>
     </div>
    </div>
    ...
    <div class="col-sm-6 col-md-3 margin-b-30">
     <div class="tile green">
      <div class="tile-title clearfix">
       Today's  currency balance
      </div>
      <div class="tile-body clearfix">
       <i class="fa fa-credit-card"></i>
       <h4 class="pull-right"><asp:Label runat="server" ID="balanceId">0</asp:Label></h4>
      </div>
      <div class="tile-footer">
       <a>Balance</a>
      </div>
