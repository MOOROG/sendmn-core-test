<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AutoDebitTransaction.aspx.cs" Inherits="Swift.web.KJBank.AutoDebitTransaction" %>
        ...
        <div class="page-wrapper">
            ...
            <div class="listtabs">
                <ul class="nav nav-tabs" role="tablist">
                    <li><a href="CustomerSetup/DepositReport.aspx">FUND DEPOSIT REPORT</a></li>
                    <li><a href="CustomerSetup/FundStatement_Customer.aspx">Fund Summary Customer Wise</a></li>
                    <li role="presentation" class="active"><a href="Javascript:void(0)" aria-controls="home" role="tab" data-toggle="tab">Auto Debit Transaction Report </a></li>
                </ul>
            </div>
            <!-- end .page title-->
            <div class="row">
