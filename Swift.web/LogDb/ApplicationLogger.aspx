<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApplicationLogger.aspx.cs" Inherits="Swift.web.LogDb.ApplicationLogger" %>
        ...
        <div class="col-sm-12">
          <div class="page-title">
            <ol class="breadcrumb">
              ...
              <li class="active"><a href="ApplicationLogger.aspx">Application Logger</a></li>
            </ol>
          </div>
        </div>
      </div>
        ...
        <div class="col-md-12">
          <div class="panel panel-default recent-activites">
            <div class="panel-heading">
              <h4 class="panel-title">Application Logger
              </h4>
