<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SendmnAPILog.aspx.cs" Inherits="Swift.web.LogDb.SendmnAPILog" %>
        ...
        <div class="col-sm-12">
          <div class="page-title">
            <ol class="breadcrumb">
              ...
              <li class="active"><a href="SendmnAPILog.aspx">Sendmn API Log</a></li>
            </ol>
          </div>
        </div>
      </div>
        ...
        <div class="col-md-12">
          <div class="panel panel-default recent-activites">
            <div class="panel-heading">
              <h4 class="panel-title">Sendmn API Log
              </h4>
