...
namespace Swift.web.LogDb {
  public partial class ThirdPartyLog : System.Web.UI.Page {

    private const string ViewFunctionId = "10121300";
    protected const string GridName = "ThirdPartyLog";
    ...
    private void LoadGrid() {
      ...
      _grid.ColumnList = new List<GridColumn>
      {
        ...
        new GridColumn("logger", "Logger", "150", "T"),
      ...
      _grid.ThisPage = "ThirdPartyLog.aspx";
      _grid.SetComma();
      _grid.InputLabelOnLeftSide = true;
      const string sql = "EXEC [Proc_LogDb] @flag = 'ThirdPartyLog'";

      thirdPartyLog_grid.InnerHtml = _grid.CreateGrid(sql);
    }
  }
}