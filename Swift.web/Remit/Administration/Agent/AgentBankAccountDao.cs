...
{
    public class AgentBankAccountDao : RemittanceDao
    {
        public DbResult Update(string user, string abaId, string agentId, string bankName, string bankBranch,
                               string accountNo, string accountName, string swiftCode, string routingNo,
                               string bankNameB, string bankBranchB,
                               string accountNoB, string accountNameB, string swiftCodeB,
                               string routingNoB, string isDefault)
        {
            ...
            sql += ", @accountNo = " + FilterString(accountName);
            sql += ", @accountName = " + FilterString(accountNo);
            ...
            sql += ", @accountNameB = " + FilterString(accountNameB);
