...
{
    public class AgentDao : RemittanceDao
    {
        #region Agent
        ...
        #endregion AgentBusinessHistory
        ...
        #endregion AgentFinancialService

        public DataSet DisplayMatchAgent(string user, string country, string agentId)
        {
        ...
        public DataSet DisplayMatchAgentWithDisLoc(string user, string district, string locationCode, string agent)
        {
