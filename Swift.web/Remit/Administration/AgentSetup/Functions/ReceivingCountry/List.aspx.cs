...
namespace Swift.web.Remit.Administration.AgentSetup.Functions.ReceivingCountry
{
    public partial class List : Page
    {
        private const string GridName = "grd_receivingCountry";
        ...
        protected void ShowHideTab()
        {
            ...
            if (agentType == "2902" || agentType == "2903" || GetActasBranch() == "Y")
            {
                ...
                SendingCountryList.InnerHtml = "<a href=\"../SendingCountry/List.aspx?agentId=" + GetAgent() + "&aType=" +
                                           GetAgentType() + "&actAsBranch=" + GetActasBranch() +
                                           "\">Sending Country List </a>";
                ...
                AgentGroupMaping.InnerHtml = "<a href=\"../AgentGroupMapping.aspx?agentId=" + GetAgent() + "&aType=" +
                                             GetAgentType() + "&actAsBranch=" + GetActasBranch() + "\">Agent Group</a>";
            }
        ...
        private void LoadInGrid()
        {
            ...
            grid.FilterList = new List<GridFilter>
                                  {
                                      ...
                                      new GridFilter("CountryName", "Sending Country Name", "LT"),
                                      new GridFilter("agentName", "Agent Name", "LT")
                                  };

            grid.ColumnList = new List<GridColumn>
                                  {
                                      new GridColumn("CountryName", "Sending Coutry Name", "", "T"),
            ...
            string sql = "[proc_rsList1] @flag = 'rA', @roleType = 's',@listType = 'in', @agentId=" + GetAgent();
            grid.SetComma();
        ...
        private void LoadExGrid()
        {
            ...
            string sql = "[proc_rsList1] @flag = 'rA', @roleType = 's',@listType = 'ex', @agentId=" + GetAgent();
            grid.SetComma();
