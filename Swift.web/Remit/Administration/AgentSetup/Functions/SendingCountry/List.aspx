<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Swift.web.Remit.Administration.AgentSetup.Functions.SendingCountry.List" %>
        ...
        <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
            <tr>
                <td height="26" class="bredCrom">
                    <div>
                        Administration » Agent Function » Sending
                Country List
                    </div>
                </td>
            </tr>
                ...
                <td height="10" width="100%">
                    <div class="tabs">
                        ...
                        <li id="receivingListTab" runat="server"></li>--%>
                            ...
                            <li><a href="#" class="selected">Sending Country List</a></li>
