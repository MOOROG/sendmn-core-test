...
namespace Swift.web.Remit.Administration.CustomerRegistration.Beneficiary
{
    public partial class Manage : System.Web.UI.Page
    {
      ...
      if (Request.Form["PayoutPatner"] != null) {
        benificiar.PayoutPatner = Request.Form["PayoutPatner"].ToString();
      } else {
        benificiar.PayoutPatner = "0";
      }
      ...
      benificiar.bInn = Request.Form["binnTxt"].ToString();
      benificiar.bIkk = Request.Form["bikkTxt"].ToString();
      ...
      var dbResult = _cd.UpdateBenificiarInformation(benificiar, GetStatic.GetUser());
        ...
        binnTxt.Text = dr["bInn"].ToString();
        bikkTxt.Text = dr["bIkk"].ToString();
