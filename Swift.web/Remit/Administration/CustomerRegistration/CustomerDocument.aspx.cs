...
namespace Swift.web.Remit.Administration.CustomerRegistration
{
    public partial class CustomerDocument : System.Web.UI.Page
    {
        ...
        private const string UploadDocFunctionId = "20208010";
        private const string ViewFunctionIdAgent = "";
        private const string UploadDocFunctionIdAgent = "";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    fileDisplay.ImageUrl = "/Remit/GetFileView.ashx?imageName=";
                    if (GetCustomerId() == "")
                    {
                ...
                //{
                //    GetStatic.CallBackJs1(Page, "customerDoc", "HideSearchDiv()");
                //}
            }
            LoadGrid();
        ...
        private void populateForm()
        {
            ...
            if (GetCustomerDocumentId() == "")
                return;
            hdnDocumentTypeId.Value = GetCustomerDocumentId();
            ...
            if (dr["fileType"].ToString() == "signature")
            {
                ...
                GetStatic.AlertMessage(this, "Signature cannot be edited");
                return;
            }
            ...
            if (dr != null)
            {
                ...
                if (dr["fileName"].ToString() != "")
                    fileDisplay.ImageUrl = "/Remit/GetFileView.ashx?imageName=" + dr["fileName"] + "&customerId=" + hdnMembershipId.Value + "&fileType=" + dr["fileType"].ToString();
        ...
        protected void saveDocument_Click(object sender, EventArgs e)
        {
            ...
            else if (fileName == "VideoFormat")
            {
                GetStatic.AlertMessage(this, "Only .jpg and .png files are allowed");
                return;
            }
        ...
        protected void downloadFile_Click(object sender, EventArgs e)
        {
            try
            {
                if (string.IsNullOrEmpty(hdnFileName.Value) && string.IsNullOrWhiteSpace(hdnFileName.Value))
                    return;
        ...
        {
            downloadFile.Visible = false;
            fileDisplay.ImageUrl = "/Remit/GetFileView.ashx?imageName=" + hdnFileName.Value + "&customerId=" + hdnMembershipId.Value + "&fileType=" + hdnFileType.Value;
            LoadGrid();
            populateForm();
        }
