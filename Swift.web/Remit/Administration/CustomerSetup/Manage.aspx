...
<head id="Head1" runat="server">
  ...
  <script type="text/javascript">
    ...
    function UpdateBlackList() {
      var cusId = $('#<%=hdnCustomerId.ClientID%>').val();
      var selectedValue = $('#<%=holdReasonTxt.ClientID%>').val();
      var selectedChkBx = $('#<%= isHold.ClientID %>').is(':checked');
      var accNum = $('#<%=bankAccountNo.ClientID%>').val();
      var mobile = $('#<%=mobile.ClientID%>').val();
      $.ajax({
        type: "POST",
        url: "../../../Autocomplete.asmx/UpdateBlacklist",
        data: '{ cusId: "' + cusId + '", reasonTxt: "' + selectedValue + '", holdFlg: "' + selectedChkBx + '", accNum: "' + accNum + '", mobile: "' + mobile + '"}',
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (data, textStatus, XMLHttpRequest) {
          var myData = JSON.parse(data.d);
          $('#<%=holdReasonTxt.ClientID%>').val(myData[0].descr);
                ...
                <div id="addEditPanel" runat="server">
                  ...
                  <div class="panel panel-default clearfix m-b-20">
                    <div class="panel-heading">
                      ...
                      <asp:DropDownList ID="isOrg" runat="server" CssClass="form-control">
                        <asp:ListItem Text="Хувь хүн" Value="4700"></asp:ListItem>
                        <asp:ListItem Text="Байгууллага" Value="4701"></asp:ListItem>
                      </asp:DropDownList>
                    </div>
                    <div class="panel-body">
                      <div class="">
                      ...
                      <div class="col-md-4 col-sm-4">
                        <div class="form-group">
                          ...
                          <asp:DropDownList runat="server" ID="countryList" name="countryList" CssClass="form-control required"></asp:DropDownList>
                        </div>
                      </div>
                      <div class="col-md-4 col-sm-4">
                        <div class="form-group">
                      ...
                      <div class="col-md-4 col-sm-4 ">
                        <div class="form-group">
                          <label>New Occupation:<span class="errormsg">*</span></label>
                          <asp:DropDownList runat="server" ID="occupType" CssClass="form-control  required"></asp:DropDownList>
                        </div>
                      </div>
                      <div class="col-md-4 col-sm-4">
                        <div class="form-group">
                      ...
                      <div class="col-md-4 col-sm-4">
                        <div class="form-group">
                          <label>Non MonPep:</label>
                          <asp:CheckBox ID="nonMonPep" runat="server" CssClass="form-control" />
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12">
                      <div class="panel panel-default recent-activites">
                        <div class="panel-heading">
                          <h4 class="panel-title">Hold Information</h4>
                        </div>
                        <div class="panel-body">
                          <div class="row">
                            <div class="col-md-6 form-group">
                              ...
                              <asp:TextBox ID="holdReasonTxt" runat="server" CssClass="form-control" TextMode="MultiLine" Height="100"></asp:TextBox>
                            </div>
                            <div class="col-md-2 form-group">
                              <asp:CheckBox ID="isHold" runat="server" CssClass="form-control" Text="Active"></asp:CheckBox>
                            </div>
                          </div>
                          <div class="row">
                            <input type="button" id="btnUpdateBl" value="Update" class="btn btn-primary" onclick="UpdateBlackList()" />
                          </div>
                        </div>
                      </div>
                    </div>
