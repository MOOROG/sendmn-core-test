                        ...
                        <div class="col-sm-12 col-md-12">
                            <div class="register-form">
                                <div class="panel  clearfix m-b-20">
                                    ...
                                    <div class="panel-body row" id="divMsg" runat="server" visible="false" style="background-color: white; color: red; font-size: 18px; font-weight: bold">
                                    </div>
                                    ...
                                    <div class="panel-body row">
                                        ...
                                        <div class="col-sm-12" >
                                            <div class="form-group">
                                                ...
                                                <asp:Button ID="btnAudit" runat="server" CssClass="btn btn-success" Visible="false" Text="Document Audited" OnClientClick="return confirm('Are You Sure You Want To Audit?');" OnClick="btnAudit_Click" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
