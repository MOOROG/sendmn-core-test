<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Swift.web.Remit.CreditRiskManagement.CreditSecurity.BankGuarantee.List" %>
        ...
        <div class="page-wrapper">
            ...
            <div class="listtabs">
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li role="presentation" class="active"><a href="Javascript:void(0)" class="selected" aria-controls="home" role="tab" data-toggle="tab">Bank Guarantee</a></li>
                        ...
                        <table width="100%">
                            <tr>
                                <td height="26" class="bredCrom">
                                    <div>Credit Risk Management » Credit Security » Bank Guarantee » List </div>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td height="10" width="100%">
                                    <div class="tabs">
                                        <ul>
                                            ...
                                            <li><a href="Javascript:void(0)" class="selected">Bank Guarantee</a></li>
