...
namespace Swift.web.Remit.CreditRiskManagement.CreditSecurity.BankGuarantee
{
    ...
    {
        private const string GridName = "grid_bankGuarantee";
        ...
        private void LoadGrid()
        {
            grid.FilterList = new List<GridFilter>
                                  {
                                      new GridFilter("guaranteeNo", "Guarantee No", "T"),
                                  };

            grid.ColumnList = new List<GridColumn>
                                  {
                                      new GridColumn("guaranteeNo", "Guarantee No", "", "T"),
            ...
            string sql = "[proc_bankGuarantee] @flag = 's', @agentId=" + grid.FilterString(GetAgentId().ToString());
            grid.SetComma();
