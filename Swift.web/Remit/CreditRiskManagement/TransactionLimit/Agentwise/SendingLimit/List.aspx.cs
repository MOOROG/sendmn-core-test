...
namespace Swift.web.Remit.CreditRiskManagement.TransactionLimit.Agentwise.SendingLimit
{
    ...
    {
        private const string GridName = "grid_sendTranAgent";
        ...
        private void LoadGrid()
        {
            grid.FilterList = new List<GridFilter>
                                  {
                                      new GridFilter("receivingCountry",     "Receiving Country",   "LT"),
                                      new GridFilter("tranType",            "Transaction Type",     "1:EXEC [proc_serviceTypeMaster] @flag='l'")
                                  };
            ...
            string sql = "[proc_sendTranLimit] @flag = 's', @agentId = " + GetAgentId();
            grid.SetComma();
