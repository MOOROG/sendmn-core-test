<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Swift.web.Remit.CreditRiskManagement.UserTopUpLimit.List" %>
...
<body>
    <form id="form1" runat="server">
                ...
                <div class="col-sm-12">
                    <div class="page-title">
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="List.aspx">User Top_Up Limit</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default ">
                                <div class="panel-heading">
                                    <h4 class="panel-title">User Top-Up Limit</h4>
        ...
        <%--    <div class="bredCrom"> Credit Risk Management » User Top-Up Limit » List </div>
