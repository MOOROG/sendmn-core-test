-<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApproveListOnly.aspx.cs" Inherits="Swift.web.Remit.ExchangeRate.ExRateTreasury.ApproveListOnly" %>
                            ...
                            <table width="100%" cellspacing="2" cellpadding="2" border="0">
                                ...
                                <tr>
                                    <td id="td_Search" runat="server" visible="true">
                                        <table class="fieldsetcss" style="margin-left: 0px; width: 1135px;">
                                            <tr>
                                                <td valign="top">
                                                    <table>
                                                        <tr>
                                            ...
                                            <tr>
                                                <td colspan="4">
                                                    <input type="button" value="Search" class="button" onclick="submit_form();">
