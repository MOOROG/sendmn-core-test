...
{
    public partial class ApproveListOnly : System.Web.UI.Page
    {
        ...
        private string GetPagingBlock(int _total_record, int _page, int _page_size)
        {
            ...
            str.Append("<tr><td colspan='40'><table width=\"100%\" cellspacing=\"2\" cellpadding=\"2\" border=\"0\">");
            str.Append("<td width=\"300px\" class=\"GridTextNormal\" nowrap='nowrap'>Result :&nbsp;<b>" + _total_record.ToString() + "</b>&nbsp;records&nbsp;");
        ...
        private void LoadGrid()
        {
            ...
            html.Append("<table class=\"exTable\" width=\"100%\" cellspacing=\"0\" cellpadding=\"2\" border=\"0\">");
        ...
        private void Approve()
        {
            ...
            Response.Redirect("ApproveListOnly.aspx");
        }
