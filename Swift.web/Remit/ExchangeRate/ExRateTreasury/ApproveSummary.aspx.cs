...
{
    public partial class ApproveSummary : System.Web.UI.Page
    {
            ...
            _tab.TabList = new List<TabField>
                               {
                                   ...
                                   new TabField("Approve", "ApproveList.aspx" + queryStrings, true),
        ...
        {
            var dt = obj.GetApproveSummary(GetStatic.GetUser(), GetExRateTreasuryIds());
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append(ComposeLabelWithValue((Convert.ToDecimal(dr["cRate"]) + Convert.ToDecimal(dr["cMargin"]) + Convert.ToDecimal(dr["cHoMargin"]) + Convert.ToDecimal(dr["cAgentMargin"])).ToString(), "tdsendagentrate", false));
                ...
                html.Append(ComposeLabelWithValue((Convert.ToDecimal(dr["pRate"]) - Convert.ToDecimal(dr["pMargin"]) - Convert.ToDecimal(dr["pHoMargin"]) - Convert.ToDecimal(dr["pAgentMargin"])).ToString(), "tdsendagentrate", false));
