...
namespace Swift.web.Remit.ExchangeRate.ExRateTreasury
{
    public partial class MyChangeList : System.Web.UI.Page
    {
        ...
        private void LoadGrid()
        {
            ...
            var ds = obj.LoadMyChangesList(GetStatic.GetUser(), _page.ToString(), _page_size, "exRateTreasuryId", sortd, "Y", cCountry.Text, cAgent.Text, cCurrency.Text, pCountry.Text, pAgent.Text, pCurrency.Text, tranType.Text);
            ...
            html.Append("<th rowspan=\"3\" class=\"headingTH\">Updated On</th>");
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                if (dr["isUpdated"].ToString().ToUpper() == "N")
                {
        ...
        private void ManageMessage(DbResult dbResult)
        {
            ...
            {
                Response.Redirect("MyChangeList.aspx");
            }
            GetStatic.AlertMessage(Page);
        }
