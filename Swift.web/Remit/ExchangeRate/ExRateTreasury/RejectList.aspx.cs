...
namespace Swift.web.Remit.ExchangeRate.ExRateTreasury
{
    public partial class RejectList : System.Web.UI.Page
    {
        ...
        private const string GridName = "grd_ertr";
        ...
        private void LoadGrid()
        {
            ...
            var ds = obj.LoadGridReject(GetStatic.GetUser(), _page.ToString(), _page_size, "exRateTreasuryId", sortd, "Y", cCountry.Text, cAgent.Text, cCurrency.Text, pCountry.Text, pAgent.Text, pCurrency.Text, tranType.Text);
            ...
            html.Append("<th colspan=\"8\" class=\"headingTH\"><center><span>Head Office</span><span id=\"agentfxs\" onclick=\"ShowAgentFxCol();\" title=\"Show Agent Fx\"><span><img src=\"../../../images/expandright-icon.png\" border=\"0\" /></span></span></center></th>");
            html.Append("<th rowspan=\"2\" colspan=\"2\" class=\"headingTH\" ondblclick=\"HideAgentFxCol();\" style=\"cursor: pointer;\"><center><span id=\"agentfxh\" onclick=\"HideAgentFxCol();\" title=\"Hide Agent Fx\"><span><img src=\"../../../images/collapseleft-icon.png\" border=\"0\" /></span></span><span>Agent FX</span><span id=\"tolerances\" onclick=\"ShowToleranceCol();\" title=\"Show Tolerance\"><span><img src=\"../../../images/expandright-icon.png\" border=\"0\" /></span></span></center></th>");
            ...
            html.Append("<th rowspan=\"3\" class=\"headingTH\">Modified By</th>");
