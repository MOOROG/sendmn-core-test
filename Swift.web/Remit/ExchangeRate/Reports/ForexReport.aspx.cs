...
{
    public partial class ForexReport : System.Web.UI.Page
    {
        ...
        private void LoadGridIrh()
        {
            ...
            var ds = obj.GetForexReportIrh(GetStatic.GetUser(), _page.ToString(), page_size.ToString(), countryOrderBy.Text, sortd, cCountry.Text, cAgent.Text, cBranch.Text, cCurrency.Text, pCountry.Text, pAgent.Text, pCurrency.Text, tranType.Text);
            ...
            html.Append("<th class=\"headingTH\" rowspan=\"2\">Sending Country</th>");
            html.Append("<th class=\"headingTH\" rowspan=\"2\">Sending Agent</th>");
            html.Append("<th class=\"headingTH\" rowspan=\"2\">Receiving Country</th>");
            html.Append("<th class=\"headingTH\" rowspan=\"2\">Receiving Agent</th>");
            html.Append("<th class=\"headingTH\" colspan=\"5\">USD vs Send Curr.</th>");
            html.Append("<th class=\"headingTH\" colspan=\"5\">USD vs Receive Curr.</th>");
            html.Append("<th class=\"headingTH\" colspan=\"2\">Send Curr. vs Receive Curr.</th>");
            html.Append("<th class=\"headingTH\" colspan=\"2\">Margin On<br/>Receive Curr./Send Curr.</th>");
            html.Append("<th class=\"headingTH\" rowspan=\"2\">Last Updated</th>");
            html.Append("</tr>");
            html.Append("<tr>");
            html.Append("<th class=\"thhorate\">Cost</th>");
            html.Append("<th class=\"thhorate\">HO Margin</th>");
            html.Append("<th class=\"thhorate\">Agent Offer</th>");
            html.Append("<th class=\"thhorate\">Agent Margin</th>");
            html.Append("<th class=\"thhorate\">Customer Offer</th>");

            html.Append("<th class=\"thsendagentrate\">Cost</th>");
            html.Append("<th class=\"thsendagentrate\">HO Margin</th>");
            html.Append("<th class=\"thsendagentrate\">Agent Offer</th>");
            html.Append("<th class=\"thsendagentrate\">Agent Margin</th>");
            html.Append("<th class=\"thsendagentrate\">Customer Offer</th>");

            html.Append("<th class=\"thhorate\">Agent Sett. Rate</th>");
            html.Append("<th class=\"thhorate\">Customer Rate</th>");

            html.Append("<th class=\"thplainwhite\">HO</th>");
            html.Append("<th class=\"thplainwhite\">Agent</th>");
            html.Append("</tr>");
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                html.Append("<td>" + dr["cCountryName"] + "</td>");
                html.Append("<td>" + dr["cAgentName"] + "</td>");
                html.Append("<td nowrap=\"nowrap\">" + dr["pCountryName"] + "</td>");
                ...
                html.Append("<td class=\"tdhorate\">" + dr["cAgentMargin"] + "</td>");
                html.Append("<td class=\"tdhorate\">" + (Convert.ToDecimal(dr["cRate"]) + Convert.ToDecimal(dr["cMargin"]) + Convert.ToDecimal(dr["cHoMargin"]) + Convert.ToDecimal(dr["cAgentMargin"])) + "</td>");

                html.Append("<td class=\"tdsendagentrate\">" + dr["pRate"] + "</td>");
                html.Append("<td class=\"tdsendagentrate\">" + dr["pHoMargin"] + "</td>");
                ...
                html.Append("<td class=\"tdplainwhite\">" + dr["crossRate"] + "</td>");
                html.Append("<td class=\"tdhorate\" nowrap=\"nowrap\">" + dr["customerRate"] + " " + dr["pCurrency"] + "</td>");
                html.Append(ComposeLabelWithValue(dr["hoGain"].ToString(), "tdplainwhite", true));
                html.Append(ComposeLabelWithValue(dr["agentGain"].ToString(), "tdplainwhite", true));
