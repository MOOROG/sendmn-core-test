...
namespace Swift.web.Remit.ExchangeRate.Reports
{
    public partial class List : System.Web.UI.Page
    {
        ...
        private const string ViewFunctionId = "30012100";
        string chkList = "";
        ...
        private string GetPagingBlock(int _total_record, int _page, int _page_size)
        {
            ...
            str.Append("<tr><td colspan='37'><table class=\"table table-responsive table-bordered table-striped\">");
