<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Approve.aspx.cs" Inherits="Swift.web.Remit.InternationalOperation.BalanceTopUp.Approve" %>
                ...
                <div class="col-sm-12">
                    <div class="page-title">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="Approve.aspx">Balance TopUp Approve</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default recent-activites">
                        ...
                        <div class="panel-heading">
                            <h4 class="panel-title">Balance TopUp Approve
                            </h4>
