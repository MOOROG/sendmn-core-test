...
namespace Swift.web.Remit.Commission.CommissionAgent.Send
{
    ...
    {
        private const string GridName = "grd_scSend";
        ...
        private void LoadGrid()
        {
            grid.ColumnList = new List<GridColumn>
                                  {
                                      ...
                                      new GridColumn("sBranchName", "R. Branch", "", "T"),
            ...
            string queryString = "sCountry=" + sCountryId + "&ssAgent=" + ssAgentId + "&sAgent=" +
                                 ...
                                 rAgentId +
                                 "&rBranch=" + rBranchId +
                                 "&state=" + stateId + "&zip=" + zipId + "&agentGroup=" + agentGroupId + "&tranType=" +
                                 tranTypeId;
            ...
            grid.RowIdField = "scSendMasterId";
            grid.SortBy = "code";
            grid.SortOrder = "ASC";
            ...
            grid.CustomLinkVariables = "scSendMasterId";
            grid.CustomLinkText1 = "<img id=\"showSlab_@scSendMasterId\" border=\"0\" title=\"View Slab\" class=\"showHand\" src=\"" + GetStatic.GetUrlRoot() + "/Images/view-detail.gif\" onclick=\"ShowSlab(@scSendMasterId);\"/>";

            string sql = "EXEC proc_scSendMaster @flag = 'm'" +
        ...
        {
            LoadSuperAgent(ref rCountry,rCountry.Text,  "");
