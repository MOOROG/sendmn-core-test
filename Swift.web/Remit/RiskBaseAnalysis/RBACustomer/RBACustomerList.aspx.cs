...
namespace Swift.web.Remit.RiskBaseAnalysis.RBACustomer
{
    public partial class RBACustomerList : System.Web.UI.Page
    {
        ...
        private void LoadGrid()
        {
            ...
            var sb = new StringBuilder("<table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" align=\"left\" class=\"TBL\">");

            sb.AppendLine("<tr >");
            //sb.AppendLine("<th class='frmTitle' nowrap='nowrap'></th>");
            sb.AppendLine("<th class='frmTitle' nowrap='nowrap' rowspan='2'>ASSESSMENT</th>");
            sb.AppendLine("<th class='frmTitle' nowrap='nowrap' rowspan='2'>CLEARED</th>");
            sb.AppendLine("<th class='frmTitle' nowrap='nowrap' colspan='2'>PENDING</th>");
            sb.AppendLine("<th class='frmTitle' nowrap='nowrap' rowspan='2'>BLOCKED</th>");
            sb.AppendLine("<th class='frmTitle' nowrap='nowrap' rowspan='2'>TOTAL</th>");
            sb.AppendLine("</tr>");

            sb.AppendLine("<tr >");
            sb.AppendLine("<th class='frmTitle' nowrap='nowrap'>Last TXN date>=30 Days</th>");
            sb.AppendLine("<th class='frmTitle' nowrap='nowrap'>Last TXN date<30 Days</th>");
            sb.AppendLine("</tr>");
