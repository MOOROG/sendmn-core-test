<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RBAReport.aspx.cs" Inherits="Swift.web.Remit.RiskBaseAnalysis.RBAReport" %>
    ...
    <table border="0" align="left" cellpadding="0" cellspacing="0">
        <tr>
            <td height="10"> 
                <div class="tabs" > 
                    <ul> 
                        <li> <a href="#" class="selected">Remittance</a></li>
                        <li> <a href="RBAReportMex.aspx">Money Exchange</a></li>
                    </ul> 
                </div> 
            </td>
        </tr>
            ...
            <td>
                ...
                <table border="0" cellspacing="0" cellpadding="0" class="formTable" width="600px">
                    ...
                    <tr id="trBenCountryCount" runat="server">
                        <td>
                            <div align="left" class="formLabel">Beneficiary Country Count:</div>
                        </td>
                        <td>
                            <asp:TextBox ID= "pCountryCountFrom" runat = "server" Width="80px" size="12"></asp:TextBox>
                        </td>
                        <td>
                            <asp:TextBox ID= "pCountryCountTo" runat = "server" Width="80px" size="12"></asp:TextBox>
                        </td>
                    </tr>
                    <tr id="trBenCount" runat="server">
                        <td>
                            <div align="left" class="formLabel">Beneficiary Count:</div>
                        </td>
                        <td>
                            <asp:TextBox ID= "beneficiaryCountFrom" runat = "server" Width="80px" size="12"></asp:TextBox>
                        </td>
                        <td>
                            <asp:TextBox ID= "beneficiaryCountTo" runat = "server" Width="80px" size="12"></asp:TextBox>
                        </td>
                    </tr>
