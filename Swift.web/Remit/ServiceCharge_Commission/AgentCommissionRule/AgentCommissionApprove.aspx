<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgentCommissionApprove.aspx.cs" Inherits="Swift.web.Remit.Commission.AgentCommissionRule.AgentCommissionApprove" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table id="Table1" style="width: 100%">                      
            <tr>
                <td height="26" class="bredCrom" colspan="2"> <div> Agent Commission Rule  » Approve</div> </td>
            </tr>
            <tr>
                <td height="20" colspan="2"> <span id="spnCname"  class="welcome" runat="server"><%=GetAgentName()%></span></td>
            </tr>
            <tr>
                <td>
