                                                                ...
                                                                <td valign="top">
                                                                    <table class="table table-responsive">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="effectiveFrom" runat="server" CssClass="form-control" TabIndex="19"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:TextBox ID="effectiveTo" runat="server" CssClass="form-control" TabIndex="20"></asp:TextBox>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div id="divSlabgrid" runat="server" visible="false">
                                                                <div id="rpt_slabgrid" runat="server" class="table table-responsive table-bordered table-striped"></div>
                                                        ...
                                                        <td>
                                                            <asp:UpdatePanel ID="upnl2" runat="server">
                                                                <ContentTemplate>
                                                                    ...
                                                                    <asp:Button ID="btnSaveDetail" runat="server" CssClass="btn btn-primary m-t-25" Text="Save" Style="display: none"
