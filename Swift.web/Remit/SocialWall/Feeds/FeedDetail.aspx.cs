...
namespace Swift.web.Remit.SocialWall.Feeds
{
    public partial class FeedDetail : System.Web.UI.Page
    {
        ...
        SocialWallGetFeeds _socialwallDao = new SocialWallGetFeeds();
        ...
        private void LoadGrid()
        {
            ...
            grdList.DataSource = myObject["_feedResponse"];
            grdList.DataBind();
            grdList.PageIndexChanged += new DataGridPageChangedEventHandler(dataGrid_PageIndexChanged);
        ...
        private object GetGrid()
        {
            ...
            var Feeds = _socialwallDao.GetFeeds();
