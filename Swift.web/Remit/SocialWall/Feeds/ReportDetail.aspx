<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportDetail.aspx.cs" Inherits="Swift.web.Remit.SocialWall.Feeds.ReportDetail" %>
<!DOCTYPE html>
                ...
                <div class="col-sm-12">
                    <div class="page-title">
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="BlockUnblockFeed.aspx">Reports Detail List </a></li>
                ...
                <div class="listtabs">
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active">
                            <a href="ReportDetail.aspx" >Reports Detail List </a></li>
                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default recent-activites">
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title">Reports Detail List 
                                        </h4>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <asp:DataGrid ID="grdReport" runat="server" CssClass="gridDiv table table-bordered table-striped table-condensed table-scroll" AllowPaging="True" PageSize="100" >
