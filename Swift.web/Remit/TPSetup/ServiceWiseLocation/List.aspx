<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Swift.web.Remit.TPSetup.ServiceWiseLocation.List" %>
        ...
        <div class="page-wrapper">
            ...
            <div class="listtabs">
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active"><a href="List.aspx" aria-controls="home" role="tab" data-toggle="tab">Service Wise Location List</a></li>
                    <li><a href="ManageLocation.aspx">Manage Service Wise Location</a></li>
                </ul>
            </div>
            <!-- Tab panes -->
