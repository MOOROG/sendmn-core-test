<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Swift.web.Remit.ThirdPartyTXN.ACDeposit.Ria.List" %>
            ...
            <div class="report-tab">
                <div class="listtabs">
                    <ul class="nav nav-tabs" role="tablist">
                        <li><a href="/Remit/ThirdPartyTXN/ACDeposit/GME/List.aspx">GME Korea</a></li>
                        <li role="presentation" class="active"><a href="/Remit/ThirdPartyTXN/ACDeposit/Ria/List.aspx">Ria Money</a></li>
                        <li><a href="/Remit/ThirdPartyTXN/ACDeposit/Ria/CancelList.aspx">Ria Money-Cancel List</a></li>
                    </ul>
                </div>
                <div class="row">
                    <div class="col-md-12">
