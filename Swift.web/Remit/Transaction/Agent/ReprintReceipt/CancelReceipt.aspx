<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CancelReceipt.aspx.cs" Inherits="Swift.web.Remit.Transaction.Agent.ReprintReceipt.CancelReceipt" %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server">
    ...
    <div class="bredCrom" style="width: 90%">Cancel Receipt <asp:Label runat="server" ID="duplicate" Visible="False">[Duplicate]</asp:Label></div>
    <h3><span style="margin-left: 20px;"></span></h3>
    <span style="margin-left: 0px; background: red; font-size: 1.5em; font-weight: bold; color: White;">
