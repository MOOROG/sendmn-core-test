...
namespace Swift.web.Remit.Transaction.ApproveTxn
{
    public partial class holdTxnList : System.Web.UI.Page
    {
        ...
        private void LoadApproveGrid(string sCountry)
        {
            ...
            {
                country.SelectedItem.Text = GetStatic.ReadWebConfig("currentCntry", "");
            }
            var ds = at.GetHoldedTXNListAdmin(GetStatic.GetUser(), branch.Text, tranNo.Text, rCountry.Text, sender.Text, receiver.Text
                ...
                , "s-admin", txnDate.Text, user.Text, ControlNo.Text, "I", country.SelectedItem.Text, agent.Text, branch.Text);
        ...
        {
            ApproveTxnMain();
            //DbResult _dbRes = at.GetTxnApproveData(GetStatic.GetUser(), hddTranNo.Value);
