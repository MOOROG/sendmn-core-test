<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PendingIntl.aspx.cs" Inherits="Swift.web.Remit.Transaction.PostAcDeposit.PaidTransaction.PendingIntl" %>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default recent-activites">
                                <div class="panel-heading">
                                    <h4 class="panel-title">Unpaid List- International
                                    </h4>
                                ...
                                <div class="panel-body">
                                    <div class="form-group" id="result" runat="server" visible="false">
                                        ...
                                        <div class="form-group">
                                            <asp:Button ID="btnPaidTxn" runat="server" Text="Pay Bank Deposit" CssClass="btn btn-primary"
                                                OnClick="btnPaidTxn_Click" OnClientClick="this.disabled='true';" UseSubmitBehavior="false" />
                                            <cc1:ConfirmButtonExtender ID="btnPaycc" runat="server"
                                                ConfirmText="Confirm To Pay Transaction?" Enabled="True" TargetControlID="btnPaidTxn">
