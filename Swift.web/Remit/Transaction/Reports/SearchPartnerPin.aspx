<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchPartnerPin.aspx.cs" Inherits="Swift.web.Remit.Transaction.Reports.SearchPartnerPin" %>
                ...
                <div class="col-sm-12">
                    <div class="page-title">
                       ...
                       <li><a href="#" onclick="return LoadModule('remittance')">Remittance</a></li>
                            ...
                            <li class="active"><a href="SearchPartnerPin.aspx">Search  Transaction </a></li>
                            
                        </ol>
                    </div>
                    <div class="panel panel-default ">
                        <div class="panel-heading">
                            <h4 class="panel-title">Search By Partner Pin</h4>
