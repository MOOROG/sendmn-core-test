...
namespace Swift.web.Remit.Transaction.Reports.StatementOfAccount
{
    public partial class PayingAgent : System.Web.UI.Page
    {
        ...
        {
            sl.SetDDL(ref sCountry, "EXEC proc_dropDownLists @flag='rCountry-payoutPartner'", "countryId", "countryName", "", "Select");
        ...
        protected void sCountry_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //sdd.SetDDL3(ref sAgent, "EXEC proc_dropDownLists @flag='rAgent-payoutPartner',@param1=" + sdd.FilterString(sCountry.Text), "agentId", "agentName", "", "Select");
