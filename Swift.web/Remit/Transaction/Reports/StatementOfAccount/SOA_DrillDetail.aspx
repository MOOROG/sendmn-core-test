<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SOA_DrillDetail.aspx.cs" Inherits="Swift.web.Remit.Transaction.Reports.StatementOfAccount.SOA_DrillDetail" %>
            ...
            <div id="DivFrm" runat="server">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">Statement Of Account  <asp:Label ID="rptTitle" runat="server"></asp:Label><asp:Label ID="collMode" runat="server"></asp:Label> </h4>
