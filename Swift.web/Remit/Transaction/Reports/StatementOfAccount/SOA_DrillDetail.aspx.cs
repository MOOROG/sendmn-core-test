        ...
        private void LoadSoaHtml()
        {
            ...
            switch (flag)
            {
                ...
                case "SEND_INTL_COMM":
                    ...
                    break;
                case "RECEIVED_INTL":
                    rptTitle.Text = " >> Received Transaction Detail";
                    break;
                case "PAY_INTL_COMM":
                    rptTitle.Text = " >> Pay Commission Detail";
                    break;
                default:
                    break;
            }
            ...
            DataTable dt = new TranAgentReportDao().AdminSoaDrilldownReportNew(fromDate, toDate, agent, flag, branch, FLAG2, rptName);
