                ...
                <div class="col-md-12">
                    <div class="panel panel-default ">
                        ...
                        <div class="panel-body">
                          ...
                          <div class="form-group">
                            <label class="control-label col-md-3">Sending Country: (only for Detail)</label>
                            <div class="col-md-8">
                              <asp:DropDownList ID="sendingCnrty" runat="server" CssClass="form-control">
                                <asp:ListItem Text="All" Value=""></asp:ListItem>
                                <asp:ListItem Text="<%$ AppSettings: currentCntry %>" Value="<%$ AppSettings: currentCntry %>"></asp:ListItem>
                              </asp:DropDownList>
                            </div>
                          </div>
...
<script language="javascript" type="text/javascript">
    ...
    function showDetailReport() {
        ...
        var TranType = document.getElementById("TranType").value;
      var fromDate = document.getElementById("fromDate").value;
      var sendingCnrty = document.getElementById("sendingCnrty").value;
      var url = "../../../../RemittanceSystem/RemittanceReports/Reports.aspx?reportName=20167500&flag=detail1&TranType=" + TranType + "&country=" + Country + "&fromDate=" + fromDate + "&sendCntry=" + sendingCnrty;
        OpenInNewWindow(url);
        return false;
    }
</script>
