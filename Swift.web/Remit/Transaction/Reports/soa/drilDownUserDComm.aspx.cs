...
{
    public partial class drilDownUserDComm : System.Web.UI.Page
    {
        ...
        private void LoadSoaHtml()
        {
            ...
            DataTable dt = rptDao.AgentSoaDrilldownUserDCommReport(fromDate, toDate, agent, agent2, flag, tranType);
