<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactVoucher.aspx.cs" Inherits="Swift.web.Remit.Transaction.ReprintVoucher.ContactVoucher" %>
            ...
            <tr valign="top">
              ...
              <td width="20%" class="amount-info">
                <table width="100%;" border="1" cellspacing="0 " cellpadding="0 ">
                  ...
                  <tr>
                    <td>
                      <p style="display: none">User:<span><asp:Label ID="createdBy" runat="server"></asp:Label></span></p>
                      <p>
                        <span>Approved Date:
              ...
              <td colspan="2">
                <table width="100%;" style="border: 1px solid #ccc; padding: 5px;">
                  ...
                  <tr>
                    ...
                    <td colspan="2">
                      <label>Chief Accountant:</label>
                      <img src="/images/SanhuuTamga.png" style="width: 200px"></td>
                /B. Oyun-Erdene/
                    </td>
                  </tr>
                </table>
