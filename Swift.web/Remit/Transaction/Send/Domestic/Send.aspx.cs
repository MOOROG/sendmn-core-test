...
namespace Swift.web.Remit.Transaction.Send.Domestic
{
    public partial class Send : System.Web.UI.Page
    {
        ...
        private SendTransactionDao _obj = new SendTransactionDao();
        private const string ViewFunctionId = "20121300";
        private const string ProcessFunctionId = "20121320";
        CustomersDao cd = new CustomersDao();
        protected void Page_Load(object sender, EventArgs e)
        {
            //txtSendDOB.Text=DateTime.Now.ToShortDateString();
            //txtSendIdValidDate.Text = DateTime.Now.ToShortDateString();
            //txtSenIdIssuedDate.Text = DateTime.Now.ToShortDateString();
        ...
        {
            //sl.SetDDL(ref location, "EXEC proc_apiLocation @flag='l'", "districtCode", "districtName", "", "Select");
        }
        #endregion
        protected void Calculate()
        {
            var sBranch = Request.Form["sBranch"];
            ...
            DataTable dt = _obj.GetCalculateHo(GetStatic.GetUser(), pLocation, tAmt, dm, sBranch, pBankBranch);
        ...
        {
            string customerId = Request.Form["customerCardNumber"];
            DataTable dt = _obj.GetCustomer(GetStatic.GetUser(), customerId);
            Response.ContentType = "text/plain";
            string json = DataTableToJSON(dt);
            Response.Write(json);
            Response.End();
        ...
        private void LoadImages()
        {
            ...
            DataTable dt = _obj.GetCustomerImages(GetStatic.GetUser(), customerId);
            Response.ContentType = "text/plain";
            string json = DataTableToJSON(dt);
            Response.Write(json);
            Response.End();
        ...
        //    var ds = st.HOValidateTransaction(tran);
        //    var dt = ds.Tables[0];
        ...
        {
            string _sBranch = Request.Form["sBranch"];
            string _sBranchName = Request.Form["sBranchName"];
            ...
            var ds = st.HOVerifyTransaction(tran);
            var dt = ds.Tables[0];
