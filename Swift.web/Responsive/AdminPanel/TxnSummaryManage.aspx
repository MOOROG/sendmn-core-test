<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TxnSummaryManage.aspx.cs" Inherits="Swift.web.Responsive.AdminPanel.TxnSummary.TxnSummaryManage" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        function OpenReport(rType) {
            ...
            var url = "/Responsive/Reports.aspx?reportName=rsptxnsummaryrpt&beneficiary=" + country +
                        "&agentName=" + agent +
                         "&branch=" + branch +
                         "&status=" + status +
                         "&date=" + dateType +
