...
namespace Swift.web.Responsive.CustomerSetup.Benificiar
{
    public partial class NewReceiverPrint : System.Web.UI.Page
    {
        ...
        {
            remittanceLibrary.CheckAuthentication(ViewFunctionId);
        ...
        {
            StringBuilder sb=new StringBuilder();
            sb.AppendLine("<table width=\"100%\"> <!--Header-->");
            sb.AppendLine("<tr><td><table width = \"100%\" class=\"header-info\">");
            sb.AppendLine("<tr><td colspan = \"2\"><h3> info@japanremit.com </h3><hr></td></tr>");
            ...
            sb.AppendLine("<tr><td> To :</td><td>INFO; SUPPORT; BASANTA; JMEJAPAN</td></tr>");
            sb.AppendLine("<tr><td> Subject :</td><td> New User</td></tr>");
