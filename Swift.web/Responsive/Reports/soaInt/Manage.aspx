<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="Swift.web.Responsive.Reports.soaInt.Manage" %>
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <table class="table table-responsive">
                                <tr>
                                    <td nowrap="nowrap" width="250px">Confirm Date From:<span class="ErrMsg">*</span>
                                    </td>
                                    <td nowrap="nowrap">
                                        <asp:TextBox ID="fromDate" runat="server" class="fromDatePicker" size="12" CssClass="form-control"></asp:TextBox>
                                ...
                                <tr>
                                    <td nowrap="nowrap">Confirm Date To :<span class="ErrMsg">*</span>
                                    </td>
                                    <td nowrap="nowrap">
                                        <asp:TextBox ID="toDate" runat="server" class="toDatePicker" size="12" CssClass="form-control"></asp:TextBox>
