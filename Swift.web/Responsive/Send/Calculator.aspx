<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Calculator.aspx.cs" Inherits="Swift.web.Responsive.Send.SendMoneyv2.Calculator" %>
                                        ...
                                        <div class="rowConatainer">
                                            <table class="table table-responsive">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:TextBox ID="txtCollAmt" runat="server" Width="150px" Enabled="false" CssClass="form-control"></asp:TextBox> <span class="ErrMsg"  id='cAmt_err'>*</span>
                                                ...
                                                <tr>
                                                    <td>Payout Amount:</td>
                                                    <td >
                                                        <asp:TextBox ID="txtPayAmt" Width="150px" runat="server" Enabled="false"  CssClass="form-control"></asp:TextBox> <span class="ErrMsg"  id='Span1'>*</span>
                                                ...
                                                <tr>
                                                    ...
                                                    <td >
                                                        ...
                                                        <input type="button" id="btnProceed" onclick="CallBack()" class="btn btn-primary m-t-25" value="Proceed Send" />
