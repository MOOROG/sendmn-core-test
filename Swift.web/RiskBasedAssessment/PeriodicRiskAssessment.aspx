<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PeriodicRiskAssessment.aspx.cs" Inherits="Swift.web.RiskBasedAssessment.PeriodicRiskAssessment" %>
            ...
            <div class="rba-tab">
                <div class="listtabs">
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li role="presentation" class="active"><a href="PeriodicRiskAssessment.aspx">New Periodic Txn Assessment</a></li>
                    </ul>
                </div>
                        ...
                        <div class="auto-style9">
                            <div class="panel panel-default ">
                                <div class="panel-heading">
                                    <h4 class="panel-title">Periodic Txn Assessment</h4>
                                    ...
                                    <table class="table table-responsive table-striped table-bordered">
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th class="auto-style13">Criteria</th>
                                        ...
                                        <tbody id="Tbody1" runat="server">
                                            <tr class="auto-style3">
                                                ...
                                                <td>
                                                    ...
                                                    <asp:DropDownList runat="server" ID="Criteria" CssClass="form-control" >
                                                    </asp:DropDownList>
                                                </td>
                                                ...
                                                <td class="auto-style15">Min.
                                                    <asp:TextBox runat="server" ID="MinValue" Width="70"></asp:TextBox>
                                                    Max.
                                                    <asp:TextBox runat="server" ID="MaxValue" Width="70"></asp:TextBox>
                                                </td>
