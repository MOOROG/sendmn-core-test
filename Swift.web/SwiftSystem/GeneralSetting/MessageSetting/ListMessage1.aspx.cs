...
{
    public partial class ListMessage1 : Page
    {
        private const string GridName = "grdMsg1";
        ...
        private void LoadGrid()
        {
            ...
            _grid.ColumnList = new List<GridColumn>
                                   {
                                       ...
                                       new GridColumn("commonMsg", "Message", "", "T"),
            ...
            _grid.AddPage = "ManageMessage1.aspx";

            string sql = "[proc_message] @flag = 's1'";
        ...
        private void DeleteRow()
        {
            ...
            if (string.IsNullOrEmpty(id))
                return;
            DbResult dbResult = _obj.DeleteMsgBlock1(GetStatic.GetUser(), id);
