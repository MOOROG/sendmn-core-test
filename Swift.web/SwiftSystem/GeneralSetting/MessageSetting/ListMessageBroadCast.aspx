<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListMessageBroadCast.aspx.cs" Inherits="Swift.web.SwiftSystem.GeneralSetting.MessageSetting.ListMessageBroadCast" %>
        ...
        <div class="page-wrapper">
                ...
                <div class="col-sm-12">
                    <div class="page-title">
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="ListMessageBroadCast.aspx">Message Setting</a></li>
                        </ol>
                    </div>
                </div>
            </div>
            <div class="listtabs">
                <ul class="nav nav-tabs" >
                    ...
                    <li class="active"> <a href="Javascript:void(0)" class="selected" target="_self">Broadcast</a></li>
        ...
        <tr>
            <td width="100%"> 
                <asp:Panel ID="pnl1" runat="server">
                    <table width="100%">
                        <tr>
                            <td height="26" class="bredCrom"> <div > General Settings » Message Setting » Message Broadcast » List </div> </td>
                        </tr>
                        <tr>
                            <td height="10" width="100%"> 
                                <div class="tabs" > 
                                    <ul>                                    
                                        ...
                                        <li> <a href="Javascript:void(0)" class="selected">Broadcast</a></li>
