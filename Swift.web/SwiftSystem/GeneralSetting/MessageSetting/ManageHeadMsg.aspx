<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" MasterPageFile="~/Swift.Master" CodeBehind="ManageHeadMsg.aspx.cs" Inherits="Swift.web.SwiftSystem.GeneralSetting.MessageSetting.ManageHeadMsg" %>
     ...
     <div class="page-wrapper">
                ...
                <div class="col-sm-12">
                    <div class="page-title">
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="ManageHeadMsg.aspx">Message Setting</a></li>
                        </ol>
                    </div>
                </div>
            </div>
            <div class="listtabs">
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li role="presentation" class="active"><a ref="Javascript:void(0)" class="selected" aria-controls="home" role="tab" data-toggle="tab">Manage</a></li>
                </ul>
            </div>
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            <td height="10" width="100%"> 
                                <div class="tabs" > 
<ul>--%>
<%--              <li> <a href="ListHeadMsg.aspx" class="selected">Head </a></li> 
                ...
                <table border="0" cellspacing="0" cellpadding="0" class="formTable" align="left" style="width: 850px;" >
                 ...
                 <%--   <tr>
                    ...
                    <tr>
                        <td>
                            <fieldset>
                                <legend>Head Message[Country Wise]</legend>
                                <table>
                                    <tr>
