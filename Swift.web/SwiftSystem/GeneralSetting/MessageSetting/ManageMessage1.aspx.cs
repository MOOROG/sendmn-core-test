...
{
    public partial class ManageMessage1 : Page
    {
        ...
        private void PopulateDataById()
        {
            ...
            textarea1.Text = dr["commonMsg"].ToString();
        ...
        private void Update()
        {
            DbResult dbResult = obj.UpdateCommonMsg(GetStatic.GetUser(), GetId().ToString(), country.Text, ddlIsActive.Text,
                                                    textarea1.Text);
        ...
        private void ManageMessage(DbResult dbResult)
        {
            ...
            {
                Response.Redirect("ListMessage1.aspx");
            }
            else
            {
