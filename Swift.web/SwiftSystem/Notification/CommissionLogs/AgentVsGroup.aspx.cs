...
{
    public partial class AgentVsGroup : System.Web.UI.Page
    {
        ...
        private const string GridName = "grdSAgentVsGroupLog";
        ...
        private void LoadGrid()
        {
            ...
            grid.ColumnList = new List<GridColumn>
                                   {
                                       ...
                                       new GridColumn("GroupCat", "Group", "", "T"),
                                       new GridColumn("SubGroup", "Sub Group", "", "T"),
            ...
            grid.ThisPage = "AgentVsGroup.aspx";
            grid.AlwaysShowFilterForm = true;
            grid.LoadGridOnFilterOnly = true;
            grid.AllowEdit = false;

            var sql = "exec proc_agentGroup @flag = 'agentVsGroup'";
            grid.SetComma();
