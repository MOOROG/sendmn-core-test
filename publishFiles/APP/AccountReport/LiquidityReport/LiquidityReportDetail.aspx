<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LiquidityReportDetail.aspx.cs" Inherits="Swift.web.AccountReport.LiquidityReport.LiquidityReportDetail" %>
                ...
                <div class="col-sm-12">
                    <div class="page-title">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Liquidity Report Detail</li>
                        </ol>
                    </div>
                </div>
            </div>
