<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReconcileTxnReport.aspx.cs" Inherits="Swift.web.AccountReport.TxnReport.ReconcileTxnReport" %>
                ...
                <div class="col-sm-12">
                    <div class="page-title">
                        <ol class="breadcrumb">
                            ...
                            <li>TXN REPORT</li>
                            <li class="active">TXN Reconciliation Report Detail</li>
                        </ol>
                    </div>
                </div>
            </div>
