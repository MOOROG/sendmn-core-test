...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container-fluid" style="height: 1500px; overflow-x: hidden; margin-top: 100px; overflow-y: hidden">
        ...
        <footer>
            <div class="container-fluid text-center">
                <p style="color:#FFF;text-align:center;background-color:#ED1C24"><%=DateTime.Today.ToString("yyyy") %> © <%= Swift.web.Library.GetStatic.ReadWebConfig("copyRightName","") %>. All rights Reserved.</p>
            </div>
        </footer>
