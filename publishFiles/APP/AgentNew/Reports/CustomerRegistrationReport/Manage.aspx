<%@ Page Title="" Language="C#" MasterPageFile="~/AgentNew/AgentMain.Master" AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="Swift.web.AgentNew.Reports.CustomerRegistrationReport.Manage" %>
            ...
            <div class="col-sm-12">
                <div class="page-title">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active"><a href="Manage.aspx">Customer Registration Report</a></li>
                    </ol>
                </div>
            </div>
        </div>
        <div id="DivFrm" class="col-md-7" runat="server">
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <label>Customer Registration Report</label>
                </div>
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3 ">
                            <asp:Button ID="BtnSearchWithAgent" runat="server" CssClass="btn btn-primary btn-sm"
                                Text="Search With Agent" ValidationGroup="rpt" OnClientClick="return showReport('withAgent');" />
                        </div>
                    </div>
                </div>
            </div>
