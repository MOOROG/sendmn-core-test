<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModifyHistory.aspx.cs" Inherits="Swift.web.AgentNew.Reports.UserwiseTransactionReport.ModifyHistory" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        function ViewTranDetail(tranId) {
            var url = "<%=Url %>";
                url += "/AgentPanel/Reports/SearchTransaction/TransactionDetail.aspx?searchBy=tranId&searchValue=" + tranId;
                OpenInNewWindow(url);
            }
    </script>
