<%@ Page Language="C#" EnableEventValidation="false" MasterPageFile="~/AgentNew/AgentMain.Master" AutoEventWireup="true" CodeBehind="holdTxnList.aspx.cs" Inherits="Swift.web.AgentNew.Transaction.ApproveTxn.holdTxnList" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script language="javascript" type="text/javascript">
        function LoadCalendars() {
            ...
            $('#<% =txnDate.ClientID%>').mask('0000-00-00');
        }
        LoadCalendars();
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        <div class="col-md-4">
                                            ...
                                            <input type="button" value="Clear Field" id="btnSclearField" class="btn btn-clear" onclick=" ClearFields(); " />
                                        </div>
                                    </div>
                                </div>
