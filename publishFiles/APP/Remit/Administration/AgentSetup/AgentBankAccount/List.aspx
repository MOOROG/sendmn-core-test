<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Swift.web.Remit.Administration.AgentSetup.AgentBankAccount.List" %>
                            ...
                            <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td height="10">
                                        <div class="tabs">
                                            <ul>
                                                <li class="active"><a href="../Functions/ListAgent.aspx">Agent List </a></li>
                                ...
                                <td height="10">
                                    <div class="listtabs row">
                                        <ul class="nav nav-tabs" role="tablist">
                                            ...
                                            <li class="active"><a href="Javascript:void(0)" class="selected">Bank Account</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
