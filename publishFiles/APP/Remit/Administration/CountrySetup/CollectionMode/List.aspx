<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Swift.web.Remit.Administration.CountrySetup.CollectionMode.List" %>
                ...
                <div class="col-sm-12">
                    <div class="page-title">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="List.aspx">Collection Mode</a></li>
                        </ol>
                    </div>
                </div>
            </div>
