<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CountryCurrency.aspx.cs" Inherits="Swift.web.Remit.Administration.CountrySetup.CountryCurrency" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ResetForm() {
            ...
            SetValueById("<% =isDefault.ClientID%>", "");
        }
                ...
                <div class="col-sm-12">
                    <div class="page-title">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="CountryCurrency.aspx">Country Setup</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default ">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">Country Currency Setup</h4>
                                            ...
                                            <div class="row form-group">
                                                <div class="col-md-5">
                                                    ...
                                                    <span class="errormsg">*</span>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="currency" ForeColor="Red"
                                                            ValidationGroup="cCurr" Display="Dynamic" ErrorMessage="Required!">
                                                ...
                                                <div class="col-md-2">
                                                    <label>
                                                        Applies For:
                                                        <span class="errormsg">*</span>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="spFlag" ForeColor="Red"
                                                            ValidationGroup="cCurr" Display="Dynamic" ErrorMessage="Required!">
                                                        </asp:RequiredFieldValidator>
                                                    </label>
                                                    <asp:DropDownList ID="spFlag" runat="server" CssClass="form-control"></asp:DropDownList>
                                                </div>
                                                <div class="col-md-2">
                                                    <label>
                                                        Is Default:
                                                    </label>
                                                    <asp:DropDownList ID="isDefault" runat="server" CssClass="form-control">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="btn btn-primary" ValidationGroup="cCurr"
                                                        OnClick="btnSave_Click" />
                                                    <asp:Button ID="btnEdit" runat="server" Text="Edit" CssClass="btn btn-primary" Style="display: none;"
