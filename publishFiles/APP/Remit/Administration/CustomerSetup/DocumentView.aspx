<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DocumentView.aspx.cs" Inherits="Swift.web.Remit.Administration.CustomerSetup.DocumentView" %>
                                    ...
                                    <div class="panel panel-default clearfix m-b-20">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <br />
                                                <asp:Button runat="server" ID="downloadFile" CssClass="btn btn-primary m-t-25" Text="Download" OnClick="downloadFile_Click" Visible="false"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
