<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Swift.Master" CodeBehind="List.aspx.cs" Inherits="Swift.web.Remit.CreditRiskManagement.CreditSecurity.CashSecurity.List" %>
    ...
    <div class="page-wrapper">
        ...
        <div class="listtabs">
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation" class="active"><a href="#" class="selected" aria-controls="home" role="tab" data-toggle="tab">Cash Security</a></li>
        ...
        <tr>
            <td width="100%">
                <asp:Panel ID="pnl1" runat="server">
                    <table width="100%">
                        <tr>
                            <td height="26" class="bredCrom"> <div > Credit Risk Management » Credit Security » Cash Security » List </div> </td>
                        </tr>
                        <tr>
                            ...
                            <td height="10" width="100%">
                                <div class="tabs">
                                    <ul>
                                        ...
                                        <li> <a href="#" class="selected">Cash Security</a></li>
