<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Swift.web.Remit.DomesticOperation.UserWiseTxnLimit.List" %>
...
<body>
                ...
                <div class="col-sm-12">
                    <div class="page-title">
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="List.aspx">User Wise Transaction Limit</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default ">
                                <div class="panel-heading">
                                    <h4 class="panel-title">User Wise Txn Limit  List</h4>
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="table-responsive table-scroll" style="width: 1024px;">
    ...
    <tr>
        <td height="26" class="bredCrom"> <div > Domestic Operation » User Wise Txn Limit » List </div> </td>
    </tr>
    <tr>
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            <td height="10" width="100%">
                                <div class="tabs">
                                    <ul>
                                        <li> <a href="" class="selected">User Wise Txn Limit List</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
