<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Swift.web.Remit.CreditRiskManagement.TransactionLimit.Agentwise.SendingLimit.List" %>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title">Collection Limit
                                    </h4>
                            ...
                            <td height="10" width="100%">
                                <div class="tabs">
                                    <ul>
                                        ...
                                        <li> <a href="../ReceivingLimit/List.aspx?agentId=<%=GetAgentId()%>">Payment Limit</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>--%>
