<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApproveList.aspx.cs" Inherits="Swift.web.Remit.ExchangeRate.ExRateTreasury.ApproveList" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function EnableDisableButton() {
            ...
            if (j == 0) {
                EnableDisableBtn("<%=btnApprove.ClientID %>", true);
            }
            else {
                EnableDisableBtn("<%=btnApprove.ClientID %>", false);
            }
        }
                ...
                <div class="col-sm-12">
                    <div class="page-title">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="ApproveList.aspx">Exchange Rate Treasury-Approve</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default recent-activites">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">Exchange Rate Treasury-Approve List
                                    </h4>
                                </div>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <input type="button" id="btnShowAllColumns" class="btn btn-primary m-t25" value="Show All Columns" onclick="ShowAllColumns();" />
                                        <div id="paginDiv" runat="server"></div>
                                        <div id="rpt_grid" runat="server" enableviewstate="false">
                                        </div>
                                        <asp:Button runat="server" ID="btnApprove" Text="Approve" CssClass="btn btn-primary m-t25"
                                            OnClick="btnApprove_Click" />
                                        <cc1:ConfirmButtonExtender ID="ConfirmButtonExtender2" runat="server"
                                            ConfirmText="Are you sure to approve selected record(s) ?" Enabled="True" TargetControlID="btnApprove">
