<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApproveSummary.aspx.cs" Inherits="Swift.web.Remit.ExchangeRate.ExRateTreasury.ApproveSummary" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table width="100%">
            <tr>
                <td align="left" valign="top" class="bredCrom">Exchange Rate Treasury » Approve Summary</td>
            </tr>
            <tr>
            ...
            <tr>
                <td>
                    <span style="color: green; font-size: 12px; font-weight: bold;"><b>Record(s) has been approved successfully</b></span>
                </td>
            </tr>
            <tr>
                <td valign="top">
