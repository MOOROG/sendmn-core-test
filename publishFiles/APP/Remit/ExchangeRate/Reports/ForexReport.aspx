<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ForexReport.aspx.cs" Inherits="Swift.web.Remit.ExchangeRate.Reports.ForexReport" %>
...
<body onload="LoadWindow()">
         ...
         <div class="page-title">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="#">Remittance</a></li>
                    ...
                    <li class="active"><a href="#">Cost Margin Report</a></li>
                                            ...
                                            <td  valign = "top" >
                                                <table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="cCountry" runat="server" CssClass="form-control"
 Width="180px" AutoPostBack="true" 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="cAgent" runat="server" CssClass="form-control"
 Width="180px" AutoPostBack="true"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="cBranch" runat="server" CssClass="form-control"
 Width="180px"></asp:DropDownList>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="cCurrency" runat="server" CssClass="form-control"
 Width="180px"></asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                </table>
                                            ...
                                            <td valign = "top">
                                                <table>
                                                    ...
                                                    <tr>
                                                        <td><label>Country</label></td>
                                                        <td>
                                                            <asp:DropDownList ID="pCountry" runat="server" CssClass="form-control"
 Width="180px" AutoPostBack="true" 
                                                    ...
                                                    <tr>
                                                        <td><label>Agent</label></td>
                                                        <td>
                                                            <asp:DropDownList ID="pAgent" runat="server" CssClass="form-control"
 Width="180px"></asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                    <tr>
 ...
 width = "180px"></asp:DropDownList>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:DropDownList ID="countryOrderBy" runat="server" CssClass="form-control"
 Width="180px">
