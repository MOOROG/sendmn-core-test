<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MoneyExchange.aspx.cs" Inherits="Swift.web.Remit.RiskBaseAnalysis.RBACriteria.MoneyExchange" %>
        ...
        <div class="page-wrapper">
            ...
            <div class="listtabs">
                <ul class="nav nav-tabs">
                    ...
                    <li class="active"> <a href="#">Money Exchange</a></li>
                </ul>
            </div>
