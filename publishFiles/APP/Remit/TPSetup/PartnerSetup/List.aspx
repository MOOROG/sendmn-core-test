<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Swift.web.Remit.Administration.PartnerSetup.List" %>
        ...
        <div class="page-wrapper">
            ...
            <div class="listtabs">
                <ul class="nav nav-tabs" role="tablist">
                    <li class="selected"><a href="#" aria-controls="home" role="tab" data-toggle="tab">Partner List</a></li>
                    <li><a href="ApprovedList.aspx">Manage Partner</a></li>
                </ul>
            </div>
            <!-- Tab panes -->
