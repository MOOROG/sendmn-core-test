<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cancel.aspx.cs" Inherits="Swift.web.Remit.Transaction.Cancel.Cancel" %>
                ...
                <div class="col-md-12">
                    <div class="page-title">
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="Cancel.aspx">Cancel Transaction </a></li>
                        </ol>
                    </div>
                </div>
            </div>
                                                            ...
                                                            <table class="table table-responsive">
                                                                <tr>
                                                                    <td>
                                                                        ...
                                                                        <br />
                                                                        <asp:TextBox ID="controlNo" runat="server" CssClass="form-control" Width="400px" autocomplete="off"></asp:TextBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
