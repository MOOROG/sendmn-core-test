<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageTransit.aspx.cs" Inherits="Swift.web.Remit.Transaction.Reports.CashManagement.ManageTransit" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function GetCashPositionReport(type) {
            ...
            url = "ReferralReportView.aspx?reportName=cashstatusreferral&flag=cash-rpt&asOfDate=" + asOfDate;// + "&branch=" + branch + "&user=" + user;
            OpenInNewWindow(url);
        }
    </script>
</head>
