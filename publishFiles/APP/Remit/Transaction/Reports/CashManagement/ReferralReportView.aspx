<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReferralReportView.aspx.cs" Inherits="Swift.web.Remit.Transaction.Reports.CashManagement.ReferralReportView" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function ExportToExcel() {
            var html = document.getElementById("downloadExcel").innerHTML;
            //alert(html);
                            ...
                            <div class="row" id="main" runat="server">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <div class="table-responsive" id="downloadExcel">
