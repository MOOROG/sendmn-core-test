                ...
                <div class="container">
                    <div class="row">
                        <div class="account-col">
                            ...
                            <p style="color:#FFF;text-align:center;background-color:#ED1C24"><%=DateTime.Today.ToString("yyyy") %> © <%= Swift.web.Library.GetStatic.ReadWebConfig("copyRightName","") %>. All rights Reserved. Version: <b><span id="spnVerion" runat="server"></span></b></p>
