<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CategoryList.aspx.cs" Inherits="Swift.web.SwiftSystem.GeneralSetting.MessageSetting.CategoryList" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../../../js/functions.js" type="text/javascript"> </script>
         <script type="text/javascript">
             ...
             function ResetForm() {
                 SetValueById("<% =categoryName.ClientID%>", "");
                 SetValueById("<% =categoryDesc.ClientID%>", "");
             }
        ...
        <tr>
            <td>
                <asp:Panel ID="pnl2" runat="server" >
                    <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
                        <tr>
                            <td height="26" class="bredCrom"> <div > Messsage Setting » Contact Category List</div> </td>
                        </tr>
                        <tr>
                            <td height="10" width="100%"> 
                                <div class="tabs" > 
                                    <ul> 
                                        <li> <a href="Javascript:void(0)" class="selected">Category List</a></li>
                                    </ul> 
                                </div>		
                            </td>
                        </tr>
                        ...
                        <table border="0" cellspacing="0" cellpadding="0" class="formTable" style="width: 500px;" >
                            ...
                            <tr>
                             ...
                             <tr>
                                ...
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="categoryName" runat="server" CssClass="input" Width="300px"></asp:TextBox>  
                                    <span class="errormsg">*</span>  
                                    <asp:RequiredFieldValidator  ID="RequiredFieldValidator2" runat="server" ControlToValidate="categoryName" 
                                                        Display="Dynamic" ErrorMessage="Required!" ValidationGroup="money" ForeColor="Red"
                                                        SetFocusOnError="True"></asp:RequiredFieldValidator>         
                                </td>
                            </tr> 
                            <tr>
                                <td class="frmLable" nowrap="nowrap">Category Desc. :</td>
                                <td nowrap="nowrap">
                                    <asp:TextBox ID="categoryDesc" runat="server" CssClass="input" Width="300px"></asp:TextBox>
                                    <span class="errormsg">*</span>  
                                    <asp:RequiredFieldValidator  ID="RequiredFieldValidator1" runat="server" ControlToValidate="categoryDesc" 
                                                        Display="Dynamic" ErrorMessage="Required!" ValidationGroup="money" ForeColor="Red"
                                                        SetFocusOnError="True"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
