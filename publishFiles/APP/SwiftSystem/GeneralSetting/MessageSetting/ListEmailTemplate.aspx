<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListEmailTemplate.aspx.cs" Inherits="Swift.web.SwiftSystem.GeneralSetting.MessageSetting.ListEmailTemplate" %>
        ...
        <div class="page-wrapper">
                ...
                <div class="col-sm-12">
                    <div class="page-title">
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="ListEmailTemplate.aspx">Message Setting</a></li>
                        </ol>
                    </div>
                </div>
            </div>
            <div class="listtabs">
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="active"><a href="Javascript:void(0)" class="selected" target="_self">Email Template </a></li>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default ">
                                <div class="panel-heading">
                                    <h4 class="panel-title">Email Template Details
                                    </h4>
        ...
        <tr>
            <td width="100%"> 
                <asp:Panel ID="pnl1" runat="server">
                    <table width="100%">
                        <tr>
                            <td height="26" class="bredCrom"> <div > General Settings » Message Setting » Email Template » List </div> </td>
                        </tr>
                        <tr>--%>
<%--  <td height="10" width="100%"> 
                                <div class="tabs" > 
                                    <ul> 
                                        ...
                                        <li> <a href="Javascript:void(0)" class="selected">Email Template </a></li>
