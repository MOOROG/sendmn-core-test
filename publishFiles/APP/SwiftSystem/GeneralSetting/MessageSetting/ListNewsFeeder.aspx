<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListNewsFeeder.aspx.cs" Inherits="Swift.web.SwiftSystem.GeneralSetting.MessageSetting.ListNewsFeeder" %>
<!DOCTYPE html>
        ...
        <div class="row">
                <div class="col-sm-12">
                    <div class="page-title">
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="ListNewsFeeder.aspx">Message Setting</a></li>
                        </ol>
                    </div>
                </div>
            </div>
          <div class="listtabs">
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li class="active"> <a href="Javascript:void(0)" class="selected" target="_self">News Feeder </a></li>
