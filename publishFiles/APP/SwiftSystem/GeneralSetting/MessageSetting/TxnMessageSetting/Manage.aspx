<%@ Page Language="C#" ValidateRequest="false"  AutoEventWireup="true" CodeBehind="Manage.aspx.cs" Inherits="Swift.web.SwiftSystem.GeneralSetting.MessageSetting.TxnMessageSetting.Manage" %>
                ...
                <tr>
                    <td height="524" valign="top" >       
                        <table border="0" cellspacing="0" cellpadding="0" class="formTable" align="left" >
                            ...
                            <tr>
                                <td class="frmLable" nowrap="nowrap" valign="top">Country</td>
                                <td><asp:TextBox ID="country" CssClass="unicodeFont" runat="server" TextMode="MultiLine" Width="600px" Height="50px"></asp:TextBox></td>                                                                                           
                            </tr>
                            <tr>
                                <td class="frmLable" nowrap="nowrap" valign="top">Service</td>
                                <td><asp:TextBox ID="service" CssClass="unicodeFont" runat="server" TextMode="MultiLine" Width="600px" Height="50px"></asp:TextBox></td>     
                            </tr>
                            <tr>
                                <td class="frmLable" nowrap="nowrap" valign="top">Code Description</td>
                                <td><asp:TextBox ID="codeDesc" CssClass="unicodeFont" runat="server" TextMode="MultiLine" Width="600px" Height="50px"></asp:TextBox></td>     
                            </tr>
                            <tr>
                                <td class="frmLable" nowrap="nowrap" valign="top">Payment Method Desc</td>
                                <td><asp:TextBox ID="paymentMethodDesc" CssClass="unicodeFont" runat="server" TextMode="MultiLine" Width="600px" Height="50px"></asp:TextBox></td>     
                            </tr>
                            <tr>
                                <td class="frmLable" nowrap="nowrap">Messaage Type</td>
                            ...
                            <tr>
                                <td class="frmLable" nowrap="nowrap">Is Active</td>
