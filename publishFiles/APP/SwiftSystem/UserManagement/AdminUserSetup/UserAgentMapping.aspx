<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserAgentMapping.aspx.cs" Inherits="Swift.web.SwiftSystem.UserManagement.AdminUserSetup.UserAgentMapping" %>
        ...
        <div class="page-wrapper">
                ...
                <div class="col-sm-12">
                    <div class="page-title">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><a href="UserAgentMapping.aspx">Admin User Setup   </a></li>
                        </ol>
                    </div>
                </div>
            </div>
            <div class="listtabs">
                <ul class="nav nav-tabs">
                    ...
                    <li class="active"><a href="#" class="selected" target="_self">User Agent Mapping</a></li>
                </ul>
            </div>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default ">
                                <div class="panel-heading">
                                    <h4 class="panel-title">User Agent Mapping</h4>
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <uc1:SwiftTextBox ID="sendAgent" runat="server" Category="sendingAgent" />
                                        </div>
